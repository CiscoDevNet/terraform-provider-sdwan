...
var (
	_ datasource.DataSource              = &VPNInterfaceDSLPPPoAFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &VPNInterfaceDSLPPPoAFeatureTemplateDataSource{}
)

func NewVPNInterfaceDSLPPPoAFeatureTemplateDataSource() datasource.DataSource {
	return &VPNInterfaceDSLPPPoAFeatureTemplateDataSource{}
}
...
func (d *VPNInterfaceDSLPPPoAFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_vpn_interface_dsl_pppoa_feature_template"
}

func (d *VPNInterfaceDSLPPPoAFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the VPN Interface DSL PPPoA feature template.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"atm_sub_interface_name": schema.StringAttribute{
				MarkdownDescription: "ATM Sub interface Name",
				Computed:            true,
			},
...
func (d *VPNInterfaceDSLPPPoAFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *VPNInterfaceDSLPPPoAFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *VPNInterfaceDSLPPPoAFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config VPNInterfaceDSLPPPoA
