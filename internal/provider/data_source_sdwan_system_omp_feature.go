...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemOMPProfileParcelDataSource{}
)
...
func (d *SystemOMPProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
