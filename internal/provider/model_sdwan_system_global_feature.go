...
type SystemGlobal struct {
	...
	LacpSystemPriorityVariable          types.String `tfsdk:"lacp_system_priority_variable"`
	EtherchannelFlowLoadBalance         types.String `tfsdk:"etherchannel_flow_load_balance"`
	EtherchannelFlowLoadBalanceVariable types.String `tfsdk:"etherchannel_flow_load_balance_variable"`
	EtherchannelVlanLoadBalance         types.Bool   `tfsdk:"etherchannel_vlan_load_balance"`
	EtherchannelVlanLoadBalanceVariable types.String `tfsdk:"etherchannel_vlan_load_balance_variable"`
	BgpCommunityNewFormat               types.Bool   `tfsdk:"bgp_community_new_format"`
	BgpCommunityNewFormatVariable       types.String `tfsdk:"bgp_community_new_format_variable"`
}
...
func (data SystemGlobal) toBody(ctx context.Context) string {
	...
	if !data.LacpSystemPriorityVariable.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.lacpSystemPriority.optionType", "variable")
			body, _ = sjson.Set(body, path+"services_global.services_ip.lacpSystemPriority.value", data.LacpSystemPriorityVariable.ValueString())
		}
	} else if data.LacpSystemPriority.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.lacpSystemPriority.optionType", "default")

		}
	} else {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.lacpSystemPriority.optionType", "global")
			body, _ = sjson.Set(body, path+"services_global.services_ip.lacpSystemPriority.value", data.LacpSystemPriority.ValueInt64())
		}
	}

	if !data.EtherchannelFlowLoadBalanceVariable.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelFlowLoadBalance.optionType", "variable")
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelFlowLoadBalance.value", data.EtherchannelFlowLoadBalanceVariable.ValueString())
		}
	} else if data.EtherchannelFlowLoadBalance.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelFlowLoadBalance.optionType", "default")

		}
	} else {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelFlowLoadBalance.optionType", "global")
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelFlowLoadBalance.value", data.EtherchannelFlowLoadBalance.ValueString())
		}
	}

	if !data.EtherchannelVlanLoadBalanceVariable.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelVlanLoadBalance.optionType", "variable")
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelVlanLoadBalance.value", data.EtherchannelVlanLoadBalanceVariable.ValueString())
		}
	} else if data.EtherchannelVlanLoadBalance.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelVlanLoadBalance.optionType", "default")
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelVlanLoadBalance.value", false)
		}
	} else {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelVlanLoadBalance.optionType", "global")
			body, _ = sjson.Set(body, path+"services_global.services_ip.etherchannelVlanLoadBalance.value", data.EtherchannelVlanLoadBalance.ValueBool())
		}
	}

	if !data.BgpCommunityNewFormatVariable.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.bgpCommunityNewFormat.optionType", "variable")
			body, _ = sjson.Set(body, path+"services_global.services_ip.bgpCommunityNewFormat.value", data.BgpCommunityNewFormatVariable.ValueString())
		}
	} else if data.BgpCommunityNewFormat.IsNull() {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.bgpCommunityNewFormat.optionType", "default")
			body, _ = sjson.Set(body, path+"services_global.services_ip.bgpCommunityNewFormat.value", false)
		}
	} else {
		if true {
			body, _ = sjson.Set(body, path+"services_global.services_ip.bgpCommunityNewFormat.optionType", "global")
			body, _ = sjson.Set(body, path+"services_global.services_ip.bgpCommunityNewFormat.value", data.BgpCommunityNewFormat.ValueBool())
		}
	}
	return body
}
...
func (data *SystemGlobal) fromBody(ctx context.Context, res gjson.Result, fullRead bool) {
	...
	data.LacpSystemPriorityVariable = types.StringNull()
	if t := res.Get(path + "services_global.services_ip.lacpSystemPriority.optionType"); t.Exists() {
		va := res.Get(path + "services_global.services_ip.lacpSystemPriority.value")
		if t.String() == "variable" {
			data.LacpSystemPriorityVariable = types.StringValue(va.String())
		} else if t.String() == "global" {
			data.LacpSystemPriority = types.Int64Value(va.Int())
		}
	}
	data.EtherchannelFlowLoadBalance = types.StringNull()
	data.EtherchannelFlowLoadBalanceVariable = types.StringNull()
	if t := res.Get(path + "services_global.services_ip.etherchannelFlowLoadBalance.optionType"); t.Exists() {
		va := res.Get(path + "services_global.services_ip.etherchannelFlowLoadBalance.value")
		if t.String() == "variable" {
			data.EtherchannelFlowLoadBalanceVariable = types.StringValue(va.String())
		} else if t.String() == "global" {
			data.EtherchannelFlowLoadBalance = types.StringValue(va.String())
		}
	}
	data.EtherchannelVlanLoadBalance = types.BoolNull()
	data.EtherchannelVlanLoadBalanceVariable = types.StringNull()
	if t := res.Get(path + "services_global.services_ip.etherchannelVlanLoadBalance.optionType"); t.Exists() {
		va := res.Get(path + "services_global.services_ip.etherchannelVlanLoadBalance.value")
		if t.String() == "variable" {
			data.EtherchannelVlanLoadBalanceVariable = types.StringValue(va.String())
		} else if t.String() == "global" {
			data.EtherchannelVlanLoadBalance = types.BoolValue(va.Bool())
		}
	}
	data.BgpCommunityNewFormat = types.BoolNull()
	data.BgpCommunityNewFormatVariable = types.StringNull()
	if t := res.Get(path + "services_global.services_ip.bgpCommunityNewFormat.optionType"); t.Exists() {
		va := res.Get(path + "services_global.services_ip.bgpCommunityNewFormat.value")
		if t.String() == "variable" {
			data.BgpCommunityNewFormatVariable = types.StringValue(va.String())
		} else if t.String() == "global" {
			data.BgpCommunityNewFormat = types.BoolValue(va.Bool())
		}
	}
}
