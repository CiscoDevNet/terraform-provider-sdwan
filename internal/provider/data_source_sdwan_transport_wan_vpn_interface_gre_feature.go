...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportWANVPNInterfaceGREProfileParcelDataSource{}
)
...
func (d *TransportWANVPNInterfaceGREProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
