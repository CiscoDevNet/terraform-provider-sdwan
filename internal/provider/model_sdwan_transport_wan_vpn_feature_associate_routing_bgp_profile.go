...
type TransportWANVPNFeatureAssociateRoutingBGPProfile struct {
...
func (data TransportWANVPNFeatureAssociateRoutingBGPProfile) getPath() string {
...
func (data TransportWANVPNFeatureAssociateRoutingBGPProfile) toBody(ctx context.Context) string {
	body := ""
...
func (data *TransportWANVPNFeatureAssociateRoutingBGPProfile) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *TransportWANVPNFeatureAssociateRoutingBGPProfile) hasChanges(ctx context.Context, state *TransportWANVPNFeatureAssociateRoutingBGPProfile) bool {
	hasChanges := false
