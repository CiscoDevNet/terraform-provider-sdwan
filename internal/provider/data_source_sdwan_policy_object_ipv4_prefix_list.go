...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectIPv4PrefixListProfileParcelDataSource{}
)
...
func (d *PolicyObjectIPv4PrefixListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
