...
type PolicyObjectStandardCommunity struct {
	Id               types.String                           `tfsdk:"id"`
	Version          types.Int64                            `tfsdk:"version"`
	Name             types.String                           `tfsdk:"name"`
	Description      types.String                           `tfsdk:"description"`
	FeatureProfileId types.String                           `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectStandardCommunityEntries `tfsdk:"entries"`
}

type PolicyObjectStandardCommunityEntries struct {
...
func (data PolicyObjectStandardCommunity) getModel() string {
	return "policy_object_standard_community"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectStandardCommunity) getPath() string {
...
func (data PolicyObjectStandardCommunity) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectStandardCommunity) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectStandardCommunityEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectStandardCommunityEntries{}
...
func (data *PolicyObjectStandardCommunity) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectStandardCommunity) isNull(ctx context.Context, res gjson.Result) bool {
