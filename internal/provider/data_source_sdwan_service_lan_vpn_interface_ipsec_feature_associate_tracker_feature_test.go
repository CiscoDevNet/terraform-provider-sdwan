...
func TestAccDataSourceSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeaturePrerequisitesConfig + testAccDataSourceSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeatureConfig(),
...
const testAccDataSourceSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeaturePrerequisitesConfig = `
...
func testAccDataSourceSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeatureConfig() string {
	config := ""
	config += `resource "sdwan_service_lan_vpn_interface_ipsec_feature_associate_tracker_feature" "test" {` + "\n"
	...
	config += `
		data "sdwan_service_lan_vpn_interface_ipsec_feature_associate_tracker_feature" "test" {
			feature_profile_id = sdwan_service_feature_profile.test.id
			service_lan_vpn_feature_id = sdwan_service_lan_vpn_feature.test.id
			service_lan_vpn_interface_ipsec_feature_id = sdwan_service_lan_vpn_interface_ipsec_feature.test.id
			id = sdwan_service_lan_vpn_interface_ipsec_feature_associate_tracker_feature.test.id
		}
	`
	return config
}
