...
func TestAccSdwanServiceLANVPNInterfaceIPSecProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_feature.test", "tunnel_mode", "ipv4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_feature.test", "ipv4_tcp_mss", "1460"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_feature.test", "ipv4_mtu", "1500"))
