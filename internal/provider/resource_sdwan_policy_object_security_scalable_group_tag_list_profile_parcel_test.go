...
func TestAccSdwanPolicyObjectSecurityScalableGroupTagListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_security_scalable_group_tag_list_profile_parcel.test", "entries.0.sgt_name", "ANY"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_security_scalable_group_tag_list_profile_parcel.test", "entries.0.tag", "65535"))
