...
type PolicyObjectSecurityLocalapp struct {
	Id               types.String                          `tfsdk:"id"`
	Version          types.Int64                           `tfsdk:"version"`
	Name             types.String                          `tfsdk:"name"`
	Description      types.String                          `tfsdk:"description"`
	FeatureProfileId types.String                          `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectSecurityLocalappEntries `tfsdk:"entries"`
}

type PolicyObjectSecurityLocalappEntries struct {
...
func (data PolicyObjectSecurityLocalapp) getModel() string {
	return "policy_object_security_localapp"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectSecurityLocalapp) getPath() string {
...
func (data PolicyObjectSecurityLocalapp) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectSecurityLocalapp) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectSecurityLocalappEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectSecurityLocalappEntries{}
...
func (data *PolicyObjectSecurityLocalapp) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectSecurityLocalapp) isNull(ctx context.Context, res gjson.Result) bool {
