...
var (
	_ datasource.DataSource              = &CiscoSIGCredentialsFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &CiscoSIGCredentialsFeatureTemplateDataSource{}
)

func NewCiscoSIGCredentialsFeatureTemplateDataSource() datasource.DataSource {
	return &CiscoSIGCredentialsFeatureTemplateDataSource{}
}
...
func (d *CiscoSIGCredentialsFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cisco_sig_credentials_feature_template"
}

func (d *CiscoSIGCredentialsFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Cisco SIG Credentials feature template.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"zscaler_partner_base_uri": schema.StringAttribute{
				MarkdownDescription: "Partner Base URI to be used in REST calls",
				Computed:            true,
			},
			...
			"zscaler_username": schema.StringAttribute{
				MarkdownDescription: "Username of Zscaler partner account",
				Computed:            true,
			},
			...
			"zscaler_password": schema.StringAttribute{
				MarkdownDescription: "Password of Zscaler partner account",
				Computed:            true,
			},
			...
			"zscaler_cloud_name": schema.Int64Attribute{
				MarkdownDescription: "Third Party Cloud Name",
				Computed:            true,
			},
			...
			"zscaler_partner_username": schema.StringAttribute{
				MarkdownDescription: "Partner User Name",
				Computed:            true,
			},
			...
			"zscaler_partner_password": schema.StringAttribute{
				MarkdownDescription: "Partner Password",
				Computed:            true,
			},
...
func (d *CiscoSIGCredentialsFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *CiscoSIGCredentialsFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CiscoSIGCredentialsFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CiscoSIGCredentials
