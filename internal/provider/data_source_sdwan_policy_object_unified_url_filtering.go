...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectUnifiedURLFilteringProfileParcelDataSource{}
)
...
func (d *PolicyObjectUnifiedURLFilteringProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
