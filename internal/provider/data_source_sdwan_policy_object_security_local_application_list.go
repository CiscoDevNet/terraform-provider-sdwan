...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSecurityLocalApplicationListProfileParcelDataSource{}
)
...
func (d *PolicyObjectSecurityLocalApplicationListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
