...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &OtherUCSEProfileParcelDataSource{}
)
...
func (d *OtherUCSEProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
