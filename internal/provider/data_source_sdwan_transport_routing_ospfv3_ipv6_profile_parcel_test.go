...
func TestAccDataSourceSdwanTransportRoutingOSPFv3IPv6ProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "distance_for_external_routes", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "distance_for_inter_area_routes", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "distance_for_intra_area_routes", "110"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "originate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "always", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "metric", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "metric_type", "type1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "spf_calculation_deplay", "200"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "initial_hold_time", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "maximum_hold_time", "10000"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "router_lsa_on_startu_p_time", "30"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.if_name", "GigabitEthernet2"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.interface_cost", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.ospf_network_type", "broadcast"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.auth_type", "no-auth"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.ranges.0.network", "3002::/96"))
