...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceLANVPNInterfaceSVIProfileParcelDataSource{}
)
...
func (d *ServiceLANVPNInterfaceSVIProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
