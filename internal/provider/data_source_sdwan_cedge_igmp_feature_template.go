...
var (
	_ datasource.DataSource              = &CEdgeIGMPFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &CEdgeIGMPFeatureTemplateDataSource{}
)

func NewCEdgeIGMPFeatureTemplateDataSource() datasource.DataSource {
	return &CEdgeIGMPFeatureTemplateDataSource{}
}
...
func (d *CEdgeIGMPFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cedge_igmp_feature_template"
}

func (d *CEdgeIGMPFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the cEdge IGMP feature template.",
...
func (d *CEdgeIGMPFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *CEdgeIGMPFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CEdgeIGMPFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CEdgeIGMP
