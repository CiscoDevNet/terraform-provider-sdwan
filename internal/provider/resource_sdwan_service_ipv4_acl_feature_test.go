...
func TestAccSdwanServiceIPv4ACLProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_ipv4_acl_feature.test", "sequences.0.conditions.0.packet_length", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_ipv4_acl_feature.test", "sequences.0.conditions.0.source_ports.0.port", "8000"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_ipv4_acl_feature.test", "sequences.0.conditions.0.tcp_state", "syn"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_ipv4_acl_feature.test", "sequences.0.actions.0.accept_dscp", "60"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_ipv4_acl_feature.test", "sequences.0.actions.0.accept_next_hop", "1.2.3.4"))
