...
func TestAccSdwanTransportRoutingOSPFv3IPv6ProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "distance_external", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "distance_inter_area", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "distance_intra_area", "110"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "default_information_originate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "default_information_originate_always", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "default_information_originate_metric", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "default_information_originate_metric_type", "type1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "spf_calculation_delay", "200"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "spf_initial_hold_time", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "spf_maximum_hold_time", "10000"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "router_lsa_on_startup_time", "30"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.name", "GigabitEthernet2"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.cost", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.network_type", "broadcast"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.interfaces.0.authentication_type", "no-auth"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_ospfv3_ipv6_profile_parcel.test", "areas.0.ranges.0.prefix", "3002::/96"))
