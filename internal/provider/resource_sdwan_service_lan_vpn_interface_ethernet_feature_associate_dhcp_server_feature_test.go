...
func TestAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateDHCPServerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateDHCPServerFeaturePrerequisitesConfig + testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateDHCPServerFeatureConfig_all(),
...
const testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateDHCPServerFeaturePrerequisitesConfig = `
...
func testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateDHCPServerFeatureConfig_all() string {
