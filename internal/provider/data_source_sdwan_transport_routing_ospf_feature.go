...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportRoutingOSPFProfileParcelDataSource{}
)
...
func (d *TransportRoutingOSPFProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
