...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceIPv6ACLProfileParcelDataSource{}
)
...
func (d *ServiceIPv6ACLProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
