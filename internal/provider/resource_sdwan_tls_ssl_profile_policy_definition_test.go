		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("sdwan_tls_ssl_profile_policy_definition.test", "decrypt_categories.0", "alcohol-and-tobacco"),
					resource.TestCheckResourceAttr("sdwan_tls_ssl_profile_policy_definition.test", "never_decrypt_categories.0", "auctions"),
					resource.TestCheckResourceAttr("sdwan_tls_ssl_profile_policy_definition.test", "skip_decrypt_categories.0", "cdns"),
