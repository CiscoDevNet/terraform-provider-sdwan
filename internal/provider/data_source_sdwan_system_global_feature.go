...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemGlobalProfileParcelDataSource{}
)
...
func (d *SystemGlobalProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
