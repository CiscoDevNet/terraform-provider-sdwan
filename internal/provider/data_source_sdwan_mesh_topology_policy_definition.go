...
var (
	_ datasource.DataSource              = &MeshTopologyPolicyDefinitionDataSource{}
	_ datasource.DataSourceWithConfigure = &MeshTopologyPolicyDefinitionDataSource{}
)

func NewMeshTopologyPolicyDefinitionDataSource() datasource.DataSource {
	return &MeshTopologyPolicyDefinitionDataSource{}
}
...
func (d *MeshTopologyPolicyDefinitionDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"site_list_versions": schema.ListAttribute{
							MarkdownDescription: "Site list versions",
							ElementType:         types.StringType,
							Computed:            true,
						},
					},
...
func (d *MeshTopologyPolicyDefinitionDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
