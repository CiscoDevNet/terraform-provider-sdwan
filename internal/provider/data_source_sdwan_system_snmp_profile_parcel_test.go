...
func TestAccDataSourceSdwanSystemSNMPProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_snmp_profile_parcel.test", "views.0.oid.0.id", "1.3.6.1.4.1.9.9.394"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_snmp_profile_parcel.test", "views.0.oid.0.exclude", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_snmp_profile_parcel.test", "trap_target_servers.0.vpn_to_reach_trap_target_server", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_snmp_profile_parcel.test", "trap_target_servers.0.ip_address_of_snmp_server", "10.75.221.156"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_snmp_profile_parcel.test", "trap_target_servers.0.udp_port_number_of_snmp_server", "161"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_snmp_profile_parcel.test", "trap_target_servers.0.source_interface_for_outgoing_snmp_trap", "GigabitEthernet1"))
