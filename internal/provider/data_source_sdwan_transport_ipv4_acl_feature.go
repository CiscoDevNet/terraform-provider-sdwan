...
var (
	_ datasource.DataSource                     = &TransportIPv4ACLProfileParcelDataSource{}
	_ datasource.DataSourceWithConfigure        = &TransportIPv4ACLProfileParcelDataSource{}
	_ datasource.DataSourceWithConfigValidators = &TransportIPv4ACLProfileParcelDataSource{}
)

func NewTransportIPv4ACLProfileParcelDataSource() datasource.DataSource {
	return &TransportIPv4ACLProfileParcelDataSource{}
}

type TransportIPv4ACLProfileParcelDataSource struct {
	client *sdwan.Client
}

func (d *TransportIPv4ACLProfileParcelDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_transport_ipv4_acl_feature"
}

func (d *TransportIPv4ACLProfileParcelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Transport IPv4 ACL Feature.",
							...
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									...
									"protocols": schema.SetAttribute{
										MarkdownDescription: "protocol number list with at least one item",
										ElementType:         types.Int64Type,
										Computed:            true,
									},
...
func (d *TransportIPv4ACLProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
...
func (d *TransportIPv4ACLProfileParcelDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *TransportIPv4ACLProfileParcelDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config TransportIPv4ACL
