...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceRoutePolicyProfileParcelDataSource{}
)
...
func (d *ServiceRoutePolicyProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
