...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportRoutingOSPFv3IPv6ProfileParcelDataSource{}
)
...
func (d *TransportRoutingOSPFv3IPv6ProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
