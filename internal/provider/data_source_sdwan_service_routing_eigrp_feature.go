...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceRoutingEIGRPProfileParcelDataSource{}
)
...
func (d *ServiceRoutingEIGRPProfileParcelDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_service_routing_eigrp_feature"
}
...
func (d *ServiceRoutingEIGRPProfileParcelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Service Routing EIGRP Feature.",
...
func (d *ServiceRoutingEIGRPProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
