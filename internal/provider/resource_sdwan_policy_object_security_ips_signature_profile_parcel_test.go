...
func TestAccSdwanPolicyObjectSecurityIPSSignatureProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_security_ips_signature_profile_parcel.test", "entries.0.generator_id", "1234"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_security_ips_signature_profile_parcel.test", "entries.0.signature_id", "5678"))
