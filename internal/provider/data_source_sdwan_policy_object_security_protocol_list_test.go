...
func TestAccDataSourceSdwanPolicyObjectSecurityProtocolListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_policy_object_security_protocol_list.test", "entries.0.protocol_name", "snmp"))
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					append(checks,
						resource.TestCheckResourceAttr("data.sdwan_policy_object_security_protocol_list.test", "name", "TF_TEST"),
						resource.TestCheckResourceAttrSet("data.sdwan_policy_object_security_protocol_list.test", "id"),
					)...),
			},
		},
	})
