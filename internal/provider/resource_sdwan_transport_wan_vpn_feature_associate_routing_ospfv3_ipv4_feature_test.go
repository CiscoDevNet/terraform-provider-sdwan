...
func TestAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4Feature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeaturePrerequisitesConfig + testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeatureConfig_all(),
...
const testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeaturePrerequisitesConfig = `
...
func testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeatureConfig_all() string {
