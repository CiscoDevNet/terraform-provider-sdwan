...
func TestAccDataSourceSdwanTransportWANVPNProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_wan_vpn_profile_parcel.test", "ipv4_static_routes.0.ipv4_route_gateway_next_ho.0.address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_wan_vpn_profile_parcel.test", "ipv4_static_routes.0.ipv4_route_gateway_next_ho.0.administrative_distance", "1"))
