...
func TestAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingBGPFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingBGPFeaturePrerequisitesConfig + testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingBGPFeatureConfig(),
...
const testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingBGPFeaturePrerequisitesConfig = `
...
func testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingBGPFeatureConfig() string {
	config := ""
	...
	config += `
		data "sdwan_transport_wan_vpn_feature_associate_routing_bgp_feature" "test" {
			feature_profile_id = sdwan_transport_feature_profile.test.id
			transport_wan_vpn_feature_id = sdwan_transport_wan_vpn_feature.test.id
			id = sdwan_transport_wan_vpn_feature_associate_routing_bgp_feature.test.id
		}
	`
	return config
}
