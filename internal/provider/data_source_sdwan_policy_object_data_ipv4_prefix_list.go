...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectDataIPv4PrefixListProfileParcelDataSource{}
)
...
func (d *PolicyObjectDataIPv4PrefixListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
