...
func TestAccSdwanTransportWANVPNInterfaceEthernetProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_duplex", "full"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_mac_address", "00-B0-D0-63-C2-26"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_ip_mtu", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_interface_mtu", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_tcp_mss", "505"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_speed", "2500"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_arp_timeout", "1200"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_autonegotiate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_media_type", "rj45"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_tloc_extension", "tloc"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_gre_tunnel_source_ip", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_xconnect", "example"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_load_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_tracker", "example"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ethernet_profile_parcel.test", "advanced_ip_directed_broadcast", "false"))
