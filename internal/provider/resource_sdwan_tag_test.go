...
func TestAccSdwanTag(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_tag.test", "name", "SYSTEM_FP_1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_tag.test", "description", "My system tag"))
