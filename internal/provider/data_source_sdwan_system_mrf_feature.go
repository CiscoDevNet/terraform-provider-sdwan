...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemMRFProfileParcelDataSource{}
)
...
func (d *SystemMRFProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
