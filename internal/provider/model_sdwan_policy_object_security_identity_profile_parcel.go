...
type PolicyObjectSecurityIdentity struct {
	Id               types.String                          `tfsdk:"id"`
	Version          types.Int64                           `tfsdk:"version"`
	Name             types.String                          `tfsdk:"name"`
	Description      types.String                          `tfsdk:"description"`
	FeatureProfileId types.String                          `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectSecurityIdentityEntries `tfsdk:"entries"`
}

type PolicyObjectSecurityIdentityEntries struct {
...
func (data PolicyObjectSecurityIdentity) getModel() string {
	return "policy_object_security_identity"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectSecurityIdentity) getPath() string {
...
func (data PolicyObjectSecurityIdentity) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectSecurityIdentity) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectSecurityIdentityEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectSecurityIdentityEntries{}
...
func (data *PolicyObjectSecurityIdentity) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectSecurityIdentity) isNull(ctx context.Context, res gjson.Result) bool {
