...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportRoutingOSPFv3IPv4ProfileParcelDataSource{}
)
...
func (d *TransportRoutingOSPFv3IPv4ProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
