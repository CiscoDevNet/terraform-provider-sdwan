...
func TestAccSdwanServiceRoutingOSPFProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_ospf_feature.test", "redistributes.0.protocol", "omp"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_ospf_feature.test", "redistributes.0.nat_dia", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_ospf_feature.test", "redistributes.0.translate_rib_metric", "false"))
