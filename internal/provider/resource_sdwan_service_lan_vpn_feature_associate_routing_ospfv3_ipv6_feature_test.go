...
func TestAccSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv6Feature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv6FeaturePrerequisitesConfig + testAccSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv6FeatureConfig_all(),
...
const testAccSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv6FeaturePrerequisitesConfig = `
...
func testAccSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv6FeatureConfig_all() string {
