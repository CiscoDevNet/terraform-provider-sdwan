...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceWirelessLANProfileParcelDataSource{}
)
...
func (d *ServiceWirelessLANProfileParcelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Service Wireless LAN Feature.",
...
func (d *ServiceWirelessLANProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
