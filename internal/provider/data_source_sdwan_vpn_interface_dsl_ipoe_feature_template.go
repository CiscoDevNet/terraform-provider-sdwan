...
var (
	_ datasource.DataSource              = &VPNInterfaceDSLIPoEFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &VPNInterfaceDSLIPoEFeatureTemplateDataSource{}
)

func NewVPNInterfaceDSLIPoEFeatureTemplateDataSource() datasource.DataSource {
	return &VPNInterfaceDSLIPoEFeatureTemplateDataSource{}
}
...
func (d *VPNInterfaceDSLIPoEFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_vpn_interface_dsl_ipoe_feature_template"
}

func (d *VPNInterfaceDSLIPoEFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the VPN Interface DSL IPoE feature template.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"internal_controller_type": schema.StringAttribute{
				MarkdownDescription: "internal controller-type",
				Computed:            true,
			},
...
func (d *VPNInterfaceDSLIPoEFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *VPNInterfaceDSLIPoEFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *VPNInterfaceDSLIPoEFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config VPNInterfaceDSLIPoE
