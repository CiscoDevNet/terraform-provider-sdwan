...
func TestAccSdwanTransportWANVPNInterfaceCellularProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_cellular_profile_parcel.test", "config_description", "WAN"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_cellular_profile_parcel.test", "tunnel_interface_allow_dbs", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_cellular_profile_parcel.test", "intrf_mtu", "1500"))
