...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectColorListProfileParcelDataSource{}
)
...
func (d *PolicyObjectColorListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
