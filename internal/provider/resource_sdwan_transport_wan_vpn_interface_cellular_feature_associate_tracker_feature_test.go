...
func TestAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerFeaturePrerequisitesConfig + testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerFeatureConfig_all(),
...
const testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerFeaturePrerequisitesConfig = `
...
func testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerFeatureConfig_all() string {
