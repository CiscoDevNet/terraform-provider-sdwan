...
func TestAccSdwanTopologyHubSpokeProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_topology_hub_spoke_feature.test", "spokes.0.hub_sites.0.preference", "1"))
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccSdwanTopologyHubSpokePrerequisitesProfileParcelConfig + testAccSdwanTopologyHubSpokeProfileParcelConfig_all(),
...
const testAccSdwanTopologyHubSpokePrerequisitesProfileParcelConfig = `
...
func testAccSdwanTopologyHubSpokeProfileParcelConfig_all() string {
