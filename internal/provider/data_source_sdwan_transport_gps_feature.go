...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportGPSProfileParcelDataSource{}
)
...
func (d *TransportGPSProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
