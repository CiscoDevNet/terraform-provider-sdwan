...
func TestAccDataSourceSdwanIntrusionPreventionPolicyDefinition(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_intrusion_prevention_policy_definition.test", "custom_signature", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_intrusion_prevention_policy_definition.test", "logging.0.external_syslog_server_ip", "10.0.0.1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_intrusion_prevention_policy_definition.test", "logging.0.external_syslog_server_vpn", "123"))
