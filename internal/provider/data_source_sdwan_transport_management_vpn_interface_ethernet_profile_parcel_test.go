...
func TestAccDataSourceSdwanTransportManagementVPNInterfaceEthernetProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_dynamic_dhcp_distance", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_ip_address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_subnet_mask", "0.0.0.0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_secondary_ip_addresses.0.ip_address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_secondary_ip_addresses.0.subnet_mask", "0.0.0.0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_iperf_server", "example"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv4_settings_auto_detect_bandwidth", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "enable_dhcpv6", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "ipv6_settings_static_ip_address", "2001:0:0:1::/64"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "arp.0.ip_address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_profile_parcel.test", "arp.0.mac_address", "00-B0-D0-63-C2-26"))
