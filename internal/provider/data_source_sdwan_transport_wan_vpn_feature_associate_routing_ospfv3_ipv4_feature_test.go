...
func TestAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4Feature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeaturePrerequisitesConfig + testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeatureConfig(),
...
const testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeaturePrerequisitesConfig = `
...
resource "sdwan_transport_routing_ospfv3_ipv4_feature" "test" {
  name                                      = "TF_TEST_OSPFV3"
  description                               = "Terraform test"
  feature_profile_id                        = sdwan_transport_feature_profile.test.id
  router_id                                 = "1.2.3.4"
...
func testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv4FeatureConfig() string {
	config := ""
	...
	config += `
		data "sdwan_transport_wan_vpn_feature_associate_routing_ospfv3_ipv4_feature" "test" {
			feature_profile_id = sdwan_transport_feature_profile.test.id
			transport_wan_vpn_feature_id = sdwan_transport_wan_vpn_feature.test.id
			id = sdwan_transport_wan_vpn_feature_associate_routing_ospfv3_ipv4_feature.test.id
		}
	`
	return config
}
