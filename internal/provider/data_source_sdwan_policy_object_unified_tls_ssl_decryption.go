...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectUnifiedTLSSSLDecryptionProfileParcelDataSource{}
)
...
func (d *PolicyObjectUnifiedTLSSSLDecryptionProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
