...
func TestAccDataSourceSdwanOtherUCSEProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_other_ucse_profile_parcel.test", "access_port_dedicated", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_other_ucse_profile_parcel.test", "access_port_shared_type", "ge1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_other_ucse_profile_parcel.test", "access_port_shared_failover_type", "ge2"))
