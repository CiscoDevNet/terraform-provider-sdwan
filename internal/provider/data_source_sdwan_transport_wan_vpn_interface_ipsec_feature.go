...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportWANVPNInterfaceIPSECProfileParcelDataSource{}
)
...
func (d *TransportWANVPNInterfaceIPSECProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
