...
func TestAccSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeaturePrerequisitesConfig + testAccSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeatureConfig_all(),
...
const testAccSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeaturePrerequisitesConfig = `
...
func testAccSdwanServiceLANVPNInterfaceIPSECFeatureAssociateTrackerFeatureConfig_all() string {
