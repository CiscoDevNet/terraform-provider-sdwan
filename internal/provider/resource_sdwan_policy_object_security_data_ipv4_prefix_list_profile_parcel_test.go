...
func TestAccSdwanPolicyObjectSecurityDataIPv4PrefixListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_security_data_ipv4_prefix_list_profile_parcel.test", "entries.0.ip_prefix", "10.0.0.0/12"))
