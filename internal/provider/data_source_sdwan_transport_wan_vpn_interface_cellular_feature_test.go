...
func TestAccDataSourceSdwanTransportWANVPNInterfaceCellularProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_wan_vpn_interface_cellular_feature.test", "enable_ipv6", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_wan_vpn_interface_cellular_feature.test", "tunnel_qos_mode", "spoke"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_wan_vpn_interface_cellular_feature.test", "qos_adaptive", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_wan_vpn_interface_cellular_feature.test", "qos_shaping_rate", "16"))
...
func testAccDataSourceSdwanTransportWANVPNInterfaceCellularProfileParcelByNameConfig() string {
	config := `resource "sdwan_transport_wan_vpn_interface_cellular_feature" "test" {` + "\n"
	config += ` name = "TF_TEST"` + "\n"
	config += ` description = "Terraform integration test"` + "\n"
	config += `	feature_profile_id = sdwan_transport_feature_profile.test.id` + "\n"
