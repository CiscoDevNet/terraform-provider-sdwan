...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSecurityProtocolListProfileParcelDataSource{}
)
...
func (d *PolicyObjectSecurityProtocolListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
