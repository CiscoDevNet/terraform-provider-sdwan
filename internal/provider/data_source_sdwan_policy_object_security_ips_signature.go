...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSecurityIPSSignatureProfileParcelDataSource{}
)
...
func (d *PolicyObjectSecurityIPSSignatureProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
