...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceSwitchportProfileParcelDataSource{}
)
...
func (d *ServiceSwitchportProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
