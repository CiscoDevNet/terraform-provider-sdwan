...
type PolicyObjectSecurityFQDN struct {
	Id               types.String                      `tfsdk:"id"`
	Version          types.Int64                       `tfsdk:"version"`
	Name             types.String                      `tfsdk:"name"`
	Description      types.String                      `tfsdk:"description"`
	FeatureProfileId types.String                      `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectSecurityFQDNEntries `tfsdk:"entries"`
}

type PolicyObjectSecurityFQDNEntries struct {
...
func (data PolicyObjectSecurityFQDN) getModel() string {
	return "policy_object_security_fqdn"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectSecurityFQDN) getPath() string {
...
func (data PolicyObjectSecurityFQDN) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectSecurityFQDN) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectSecurityFQDNEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectSecurityFQDNEntries{}
...
func (data *PolicyObjectSecurityFQDN) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectSecurityFQDN) isNull(ctx context.Context, res gjson.Result) bool {
