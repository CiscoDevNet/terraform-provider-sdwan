...
func TestAccSdwanTransportWANVPNInterfaceIPSECProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "multiplexing", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "tunnel_mode", "ipv4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "ipv4_tcp_mss", "1460"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "ipv4_mtu", "1500"))
