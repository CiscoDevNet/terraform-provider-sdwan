		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("sdwan_cedge_pim_feature_template.test", "scope", "1"),
					resource.TestCheckResourceAttr("sdwan_cedge_pim_feature_template.test", "range", "16"),
					resource.TestCheckResourceAttr("sdwan_cedge_pim_feature_template.test", "default", "true"),
					resource.TestCheckResourceAttr("sdwan_cedge_pim_feature_template.test", "rp_addresses.0.ip_address", "1.2.3.4"),
