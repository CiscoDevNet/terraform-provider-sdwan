...
func TestAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeaturePrerequisitesConfig + testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeatureConfig_all(),
...
const testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeaturePrerequisitesConfig = `
...
func testAccSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeatureConfig_all() string {
