...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportT1E1ControllerProfileParcelDataSource{}
)
...
func (d *TransportT1E1ControllerProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
