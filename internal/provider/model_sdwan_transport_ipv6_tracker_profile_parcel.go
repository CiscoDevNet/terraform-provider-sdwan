...
func (data TransportIPv6Tracker) getModel() string {
	return "transport_ipv6_tracker"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data TransportIPv6Tracker) getPath() string {
	return fmt.Sprintf("/v1/feature-profile/sdwan/transport/%v/ipv6-tracker", url.QueryEscape(data.FeatureProfileId.ValueString()))
}

// End of section. //template:end getPath

// Section below is generated&owned by "gen/generator.go". //template:begin toBody
func (data TransportIPv6Tracker) toBody(ctx context.Context) string {
	body := ""
...
func (data *TransportIPv6Tracker) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *TransportIPv6Tracker) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *TransportIPv6Tracker) isNull(ctx context.Context, res gjson.Result) bool {
