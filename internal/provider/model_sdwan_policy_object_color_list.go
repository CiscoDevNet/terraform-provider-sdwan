...
func (data *PolicyObjectColorList) fromBody(ctx context.Context, res gjson.Result, fullRead bool) {
	...
	if !fullRead {
		resultEntries := make([]PolicyObjectColorListEntries, 0, len(data.Entries))
