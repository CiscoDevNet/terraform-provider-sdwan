...
func TestAccSdwanTransportWANVPNInterfaceIPSECProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "interface_name", "ipsec987"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "ipv4_address", "9.7.5.4"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "ipv4_subnet_mask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "tunnel_source_ipv4_address", "1.3.5.88"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "tunnel_source_ipv4_subnet_mask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "tunnel_source_interface", "GigabitEthernet8"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "tunnel_destination_ipv4_address", "2.55.67.99"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "tunnel_destination_ipv4_subnet_mask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "application_tunnel_type", "none"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_ipsec_feature.test", "ike_preshared_key", "123"))
