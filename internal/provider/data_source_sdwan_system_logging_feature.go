...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemLoggingProfileParcelDataSource{}
)
...
func (d *SystemLoggingProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
