		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.sdwan_url_filtering_policy_definition.test", "alerts.0", "blacklist"),
					resource.TestCheckResourceAttr("data.sdwan_url_filtering_policy_definition.test", "web_categories.0", "alcohol-and-tobacco"),
					...
					resource.TestCheckResourceAttr("data.sdwan_url_filtering_policy_definition.test", "target_vpns.0", "1"),
