...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceRoutingOSPFv3IPv4ProfileParcelDataSource{}
)
...
func (d *ServiceRoutingOSPFv3IPv4ProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
