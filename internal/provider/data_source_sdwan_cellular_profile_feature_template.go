...
var (
	_ datasource.DataSource              = &CellularProfileFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &CellularProfileFeatureTemplateDataSource{}
)

func NewCellularProfileFeatureTemplateDataSource() datasource.DataSource {
	return &CellularProfileFeatureTemplateDataSource{}
}
...
func (d *CellularProfileFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cellular_profile_feature_template"
}

func (d *CellularProfileFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Cellular Profile feature template.",
...
func (d *CellularProfileFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *CellularProfileFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CellularProfileFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CellularProfile
