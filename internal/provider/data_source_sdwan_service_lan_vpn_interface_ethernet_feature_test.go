...
func TestAccDataSourceSdwanServiceLANVPNInterfaceEthernetProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "ipv6_address", "2001:0:0:1::0/64"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "ipv6_vrrps.0.follow_dual_router_high_availability", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "ipv6_vrrps.0.min_preempt_delay", "60"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "ipv4_vrrps.0.follow_dual_router_high_availability", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "ipv4_vrrps.0.min_preempt_delay", "60"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "trustsec_enable_sgt_propogation", "true"))
	...
	if os.Getenv("SDWAN_2018") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "trustsec_trusted", "true"))
	}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDataSourceSdwanServiceLANVPNInterfaceEthernetPrerequisitesProfileParcelConfig + testAccDataSourceSdwanServiceLANVPNInterfaceEthernetProfileParcelByNameConfig(),
				Check: resource.ComposeTestCheckFunc(
					append(checks,
						resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "name", "TF_TEST"),
						resource.TestCheckResourceAttrSet("data.sdwan_service_lan_vpn_interface_ethernet_feature.test", "id"),
					)...),
			},
		},
	})
...
func testAccDataSourceSdwanServiceLANVPNInterfaceEthernetProfileParcelConfig() string {
	...
	config += `	ipv6_address = "2001:0:0:1::0/64"` + "\n"
...
func testAccDataSourceSdwanServiceLANVPNInterfaceEthernetProfileParcelByNameConfig() string {
	config := `resource "sdwan_service_lan_vpn_interface_ethernet_feature" "test" {` + "\n"
	config += ` name = "TF_TEST"` + "\n"
	config += ` description = "Terraform integration test"` + "\n"
	config += `	feature_profile_id = sdwan_service_feature_profile.test.id` + "\n"
