...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportWANVPNInterfaceCellularProfileParcelDataSource{}
)
...
func (d *TransportWANVPNInterfaceCellularProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
