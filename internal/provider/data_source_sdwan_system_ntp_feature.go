...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemNTPProfileParcelDataSource{}
)
...
func (d *SystemNTPProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
