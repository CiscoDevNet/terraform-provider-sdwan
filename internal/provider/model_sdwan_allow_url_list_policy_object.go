...
func (data *AllowURLListPolicyObject) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("entries"); value.Exists() && len(value.Array()) > 0 {
		data.Entries = make([]AllowURLListPolicyObjectEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := AllowURLListPolicyObjectEntries{}
...
func (data *AllowURLListPolicyObject) hasChanges(ctx context.Context, state *AllowURLListPolicyObject) bool {
	hasChanges := false
