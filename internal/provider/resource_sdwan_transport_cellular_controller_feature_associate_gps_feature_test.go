...
func TestAccSdwanTransportCellularControllerFeatureAssociateGPSFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportCellularControllerFeatureAssociateGPSFeaturePrerequisitesConfig + testAccSdwanTransportCellularControllerFeatureAssociateGPSFeatureConfig_all(),
...
const testAccSdwanTransportCellularControllerFeatureAssociateGPSFeaturePrerequisitesConfig = `
...
func testAccSdwanTransportCellularControllerFeatureAssociateGPSFeatureConfig_all() string {
