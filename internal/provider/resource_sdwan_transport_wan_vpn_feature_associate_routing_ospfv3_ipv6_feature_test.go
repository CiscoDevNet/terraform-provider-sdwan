...
func TestAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6Feature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeaturePrerequisitesConfig + testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeatureConfig_all(),
...
const testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeaturePrerequisitesConfig = `
...
func testAccSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeatureConfig_all() string {
