...
func (p *SdwanProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewPolicyObjectAppProbeProfileParcelResource,
		NewPolicyObjectASPathProfileParcelResource,
		...
		NewPolicyObjectSecurityFQDNProfileParcelResource,
		NewPolicyObjectSecurityGeolocationProfileParcelResource,
		NewPolicyObjectSecurityIdentityProfileParcelResource,
		...
		NewPolicyObjectSecurityPortProfileParcelResource,
		NewPolicyObjectSecurityScalableGroupTagProfileParcelResource,
		NewPolicyObjectSecurityURLlistProfileParcelResource,
		NewPolicyObjectStandardCommunityProfileParcelResource,
...
func (p *SdwanProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewPolicyObjectAppProbeProfileParcelDataSource,
		NewPolicyObjectASPathProfileParcelDataSource,
		...
		NewPolicyObjectSecurityDataIPPrefixProfileParcelDataSource,
		NewPolicyObjectSecurityFQDNProfileParcelDataSource,
		NewPolicyObjectSecurityGeolocationProfileParcelDataSource,
		...
		NewPolicyObjectSecurityScalableGroupTagProfileParcelDataSource,
		NewPolicyObjectSecurityURLlistProfileParcelDataSource,
		NewPolicyObjectStandardCommunityProfileParcelDataSource,
