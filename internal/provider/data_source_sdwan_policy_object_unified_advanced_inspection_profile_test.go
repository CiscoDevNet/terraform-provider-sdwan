...
func TestAccDataSourceSdwanPolicyObjectUnifiedAdvancedInspectionProfileProfileParcel(t *testing.T) {
	if os.Getenv("SDWAN_2012") == "" {
		t.Skip("skipping test, set environment variable SDWAN_2012")
	}
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_policy_object_unified_advanced_inspection_profile.test", "tls_decryption_action", "decrypt"))
...
const testAccDataSourceSdwanPolicyObjectUnifiedAdvancedInspectionProfilePrerequisitesProfileParcelConfig = `
...
func testAccDataSourceSdwanPolicyObjectUnifiedAdvancedInspectionProfileProfileParcelConfig() string {
	...
	config += `
		data "sdwan_policy_object_unified_advanced_inspection_profile" "test" {
			id = sdwan_policy_object_unified_advanced_inspection_profile.test.id
			feature_profile_id = sdwan_policy_object_feature_profile.test.id
		}
	`
	return config
