...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSecurityZoneProfileParcelDataSource{}
)
...
func (d *PolicyObjectSecurityZoneProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
