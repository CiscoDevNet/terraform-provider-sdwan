...
func TestAccSdwanNetworkHierarchySecurityLogging(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_network_hierarchy_security_logging.test", "node_id", "5333c142-394b-47a7-afa6-760c44ca3cb5"))
...
func testAccSdwanNetworkHierarchySecurityLoggingConfig_all() string {
	...
	config += `	node_id = "5333c142-394b-47a7-afa6-760c44ca3cb5"` + "\n"
