...
func TestAccSdwanTransportWANVPNFeatureAssociateRoutingBGPProfile(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportWANVPNFeatureAssociateRoutingBGPProfilePrerequisitesConfig + testAccSdwanTransportWANVPNFeatureAssociateRoutingBGPProfileConfig_all(),
...
const testAccSdwanTransportWANVPNFeatureAssociateRoutingBGPProfilePrerequisitesConfig = `
...
func testAccSdwanTransportWANVPNFeatureAssociateRoutingBGPProfileConfig_all() string {
