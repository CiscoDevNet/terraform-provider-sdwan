...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSecurityLocalDomainListProfileParcelDataSource{}
)
...
func (d *PolicyObjectSecurityLocalDomainListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
