...
func TestAccSdwanTransportWANVPNInterfaceGREProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_gre_feature.test", "interface_name", "gre1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_gre_feature.test", "ipv4_address", "70.1.1.1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_gre_feature.test", "ipv4_subnet_mask", "255.255.255.0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_wan_vpn_interface_gre_feature.test", "tunnel_destination_ipv4_address", "79.1.1.1"))
