...
func TestAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6Feature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeaturePrerequisitesConfig + testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeatureConfig(),
...
const testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeaturePrerequisitesConfig = `
...
resource "sdwan_transport_routing_ospfv3_ipv6_feature" "test" {
  name                                      = "TF_TEST_OSPFV3_IPV6"
  description                               = "Terraform test"
  feature_profile_id                        = sdwan_transport_feature_profile.test.id
  router_id                                 = "1.2.3.4"
  distance                                  = 110
...
func testAccDataSourceSdwanTransportWANVPNFeatureAssociateRoutingOSPFv3IPv6FeatureConfig() string {
	config := ""
	...
	config += `
		data "sdwan_transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature" "test" {
			feature_profile_id = sdwan_transport_feature_profile.test.id
			transport_wan_vpn_feature_id = sdwan_transport_wan_vpn_feature.test.id
			id = sdwan_transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature.test.id
		}
	`
	return config
}
