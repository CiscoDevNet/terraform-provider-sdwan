...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportRoutePolicyProfileParcelDataSource{}
)
...
func (d *TransportRoutePolicyProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
