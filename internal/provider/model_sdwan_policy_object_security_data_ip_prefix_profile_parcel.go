...
type PolicyObjectSecurityDataIPPrefix struct {
	Id               types.String                              `tfsdk:"id"`
	Version          types.Int64                               `tfsdk:"version"`
	Name             types.String                              `tfsdk:"name"`
	Description      types.String                              `tfsdk:"description"`
	FeatureProfileId types.String                              `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectSecurityDataIPPrefixEntries `tfsdk:"entries"`
}

type PolicyObjectSecurityDataIPPrefixEntries struct {
...
func (data PolicyObjectSecurityDataIPPrefix) getModel() string {
	return "policy_object_security_data_ip_prefix"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectSecurityDataIPPrefix) getPath() string {
...
func (data PolicyObjectSecurityDataIPPrefix) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectSecurityDataIPPrefix) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectSecurityDataIPPrefixEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectSecurityDataIPPrefixEntries{}
...
func (data *PolicyObjectSecurityDataIPPrefix) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectSecurityDataIPPrefix) isNull(ctx context.Context, res gjson.Result) bool {
