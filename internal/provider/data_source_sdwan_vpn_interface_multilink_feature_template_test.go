...
func TestAccDataSourceSdwanVPNInterfaceMultilinkFeatureTemplate(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "ipv6_access_lists.0.acl_name", "ACL1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "ppp_authentication_type", "callin"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_encapsulations.0.encapsulation", "gre"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_encapsulations.0.preference", "4294967"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_encapsulations.0.weight", "250"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_border", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_qos_mode", "spoke"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_color", "custom1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_last_resort_circuit", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_low_bandwidth_link", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_tunnel_tcp_mss", "1460"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_clear_dont_fragment", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_network_broadcast", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_max_control_connections", "8"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_control_connections", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_vbond_as_stun_server", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_vmanage_connection_preference", "5"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_port_hop", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_color_restrict", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_carrier", "carrier1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_nat_refresh_interval", "15"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_hello_interval", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_hello_tolerance", "12"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_bind_loopback_tunnel", "12"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_all", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_bgp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_dhcp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_dns", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_icmp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_ssh", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_ntp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_netconf", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_ospf", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_stun", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_snmp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "tunnel_interface_allow_https", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "shutdown", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "autonegotiate", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "qos_map_vpn", "test"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "multilink_interfaces.0.internal", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "multilink_interfaces.0.description", "example-interface"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_vpn_interface_multilink_feature_template.test", "multilink_interfaces.0.linecode", "ami"))
