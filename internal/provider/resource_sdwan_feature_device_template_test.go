...
func TestAccSdwanFeatureDeviceTemplate(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanFeatureDeviceTemplateConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("sdwan_feature_device_template.test", "name", "Example"),
					resource.TestCheckResourceAttr("sdwan_feature_device_template.test", "description", "My description"),
...
const testAccSdwanFeatureDeviceTemplateConfig = `
