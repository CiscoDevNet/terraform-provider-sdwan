...
func TestAccSdwanFeatureDeviceTemplate(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_feature_device_template.test", "description", "My description"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_feature_device_template.test", "device_type", "vedge-ISR-4331"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_feature_device_template.test", "general_templates.0.type", "cisco_system"))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanFeatureDeviceTemplatePrerequisitesConfig + testAccSdwanFeatureDeviceTemplateConfig_all(),
