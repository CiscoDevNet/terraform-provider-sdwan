...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemRemoteAccessProfileParcelDataSource{}
)
...
func (d *SystemRemoteAccessProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
