...
func TestAccSdwanVPNInterfaceMultilinkFeatureTemplate(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "ipv6_access_lists.0.acl_name", "Egress ACL - IPv4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "authentication_type", "callin"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "encapsulation.0.encapsulation_type", "gre"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "encapsulation.0.preference", "4294967"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "encapsulation.0.weight", "250"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "border", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "color", "custom1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "last_resort_circuit", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "low_bandwidth_link", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "tunnel_tcp_mss", "1460"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "enable_clear_dont_fragment", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "network_broadcast_1", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "max_control_connections", "8"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "control_connections", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "vbond_as_stun_server", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "vmanage_connection_preference", "5"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "port_hop", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "restrict", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "carrier", "carrier1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "nat_refresh_interval", "15"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "hello_interval", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "hello_tolerance", "12"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "bind_loopback_tunnel", "12"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "all", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "network_broadcast_2", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "bgp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "dhcp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "dns", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "icmp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "ssh", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "netconf", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "ospf", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "stun", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "snmp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "https", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "ip_directed_broadcast", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "administrative_shutdown", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "link_autonegotiate", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "vpn_qos_map", "test"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "write_rule", "test_rule"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "access_list.0.direction", "in"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "access_list.0.acl_name", "Egress ACL - IPv4"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.card_type", "E1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.slot", "interface-t1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.framing", "example-framing"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.line_mode", "primary"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.internal", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.description", "example-interface"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.linecode", "ami"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.set_length_for_long", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.set_length_for_short", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "controller_tx_ex_list.0.channel_group_list.0.channel_group", "30"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_vpn_interface_multilink_feature_template.test", "nim_interface_list.0.interface_description", "interface description"))
