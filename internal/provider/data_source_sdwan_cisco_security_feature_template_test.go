		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.sdwan_cisco_security_feature_template.test", "keys.0.send_lifetime", "true"),
					...
					resource.TestCheckResourceAttr("data.sdwan_cisco_security_feature_template.test", "keys.0.accept_lifetime", "true"),
