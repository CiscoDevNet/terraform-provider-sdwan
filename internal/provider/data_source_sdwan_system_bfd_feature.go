...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemBFDProfileParcelDataSource{}
)
...
func (d *SystemBFDProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
