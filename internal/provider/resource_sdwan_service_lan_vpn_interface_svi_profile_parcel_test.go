...
func TestAccSdwanServiceLANVPNInterfaceSVIProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_svi_profile_parcel.test", "subnet_mask", "0.0.0.0"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_svi_profile_parcel.test", "ipv4_secondary_addresses.0.ipv4_address", "2.3.4.5"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_svi_profile_parcel.test", "ipv4_secondary_addresses.0.subnet_mask", "0.0.0.0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_svi_profile_parcel.test", "ipv6_secondary_addresses.0.ipv6_address", "::2/32"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_svi_profile_parcel.test", "ipv4_vrrps.0.ip_address", "1.2.3.4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_svi_profile_parcel.test", "ipv4_vrrps.0.tloc_pref_change_value", "100"))
