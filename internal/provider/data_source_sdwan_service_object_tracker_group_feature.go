...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceObjectTrackerGroupProfileParcelDataSource{}
)
...
func (d *ServiceObjectTrackerGroupProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
