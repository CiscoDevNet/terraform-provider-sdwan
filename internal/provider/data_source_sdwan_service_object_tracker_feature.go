...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceObjectTrackerProfileParcelDataSource{}
)
...
func (d *ServiceObjectTrackerProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
