...
func TestAccDataSourceSdwanDNSSecurityPolicyDefinition(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_dns_security_policy_definition.test", "cisco_sig_credentials_feature_template_id", "3ac6eef9-bd8f-458d-96a7-a932c90b1e75"))
