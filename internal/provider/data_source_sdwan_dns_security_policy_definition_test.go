...
func TestAccDataSourceSdwanDNSSecurityPolicyDefinition(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_dns_security_policy_definition.test", "cisco_sig_credentials_feature_template_id", "839264db-3eac-441b-8e73-42b60bec9c7f"))
