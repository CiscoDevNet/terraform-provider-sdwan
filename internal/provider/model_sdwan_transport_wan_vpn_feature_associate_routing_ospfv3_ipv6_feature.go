...
func (data TransportWANVPNFeatureAssociateRoutingOSPFv3IPv6Feature) getPath() string {
	return fmt.Sprintf("/v1/feature-profile/sdwan/transport/%v/wan/vpn/%s/routing/ospfv3/ipv6/", url.QueryEscape(data.FeatureProfileId.ValueString()), url.QueryEscape(data.TransportWanVpnFeatureId.ValueString()))
}
...
func (data *TransportWANVPNFeatureAssociateRoutingOSPFv3IPv6Feature) hasChanges(ctx context.Context, state *TransportWANVPNFeatureAssociateRoutingOSPFv3IPv6Feature) bool {
	hasChanges := false
