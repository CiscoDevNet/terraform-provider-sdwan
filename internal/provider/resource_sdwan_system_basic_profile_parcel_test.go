...
func TestAccSdwanSystemBasicProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "longitude", "-77"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "latitude", "38"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "enable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "range", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "sms_enable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "mobile_numbers.0.number", "+11111233"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "port_hop", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "console_baud_rate", "4800"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "epfr", "disabled"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "affinity_per_vrf.0.affinity_group_number", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_basic_profile_parcel.test", "affinity_per_vrf.0.vrf_range", "123-456"))
