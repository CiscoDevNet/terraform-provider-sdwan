...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemAAAProfileParcelDataSource{}
)
...
func (d *SystemAAAProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
