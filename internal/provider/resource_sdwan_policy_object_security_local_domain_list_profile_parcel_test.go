...
func TestAccSdwanPolicyObjectSecurityLocalDomainListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_security_local_domain_list_profile_parcel.test", "entries.0.local_domain", "hello.com"))
