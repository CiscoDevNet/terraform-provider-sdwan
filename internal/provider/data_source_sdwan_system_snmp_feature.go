...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemSNMPProfileParcelDataSource{}
)
...
func (d *SystemSNMPProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
