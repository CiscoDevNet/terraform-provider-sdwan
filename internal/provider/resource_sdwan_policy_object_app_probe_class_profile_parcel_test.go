...
func TestAccSdwanPolicyObjectAppProbeClassProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_app_probe_class_profile_parcel.test", "entries.0.map.0.color", "3g"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_app_probe_class_profile_parcel.test", "entries.0.map.0.dscp", "45"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_app_probe_class_profile_parcel.test", "entries.0.forwarding_class", "classlist1"))
