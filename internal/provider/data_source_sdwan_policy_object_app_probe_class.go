...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectAppProbeClassProfileParcelDataSource{}
)
...
func (d *PolicyObjectAppProbeClassProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
