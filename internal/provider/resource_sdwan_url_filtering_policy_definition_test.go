...
func TestAccSdwanURLFilteringPolicyDefinition(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_url_filtering_policy_definition.test", "logging.0.external_syslog_server_ip", "10.0.0.1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_url_filtering_policy_definition.test", "logging.0.external_syslog_server_vpn", "123"))
