...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemSecurityProfileParcelDataSource{}
)
...
func (d *SystemSecurityProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
