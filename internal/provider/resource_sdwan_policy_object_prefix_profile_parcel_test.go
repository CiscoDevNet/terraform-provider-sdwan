...
func TestAccSdwanPolicyObjectPrefixProfileParcel(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanPolicyObjectPrefixPrerequisitesProfileParcelConfig + testAccSdwanPolicyObjectPrefixProfileParcelConfig_minimum(),
			},
			{
				Config: testAccSdwanPolicyObjectPrefixPrerequisitesProfileParcelConfig + testAccSdwanPolicyObjectPrefixProfileParcelConfig_all(),
...
const testAccSdwanPolicyObjectPrefixPrerequisitesProfileParcelConfig = `
