...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSLAClassListProfileParcelDataSource{}
)
...
func (d *PolicyObjectSLAClassListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
