...
var (
	_ datasource.DataSource              = &IPv6ACLPolicyDefinitionDataSource{}
	_ datasource.DataSourceWithConfigure = &IPv6ACLPolicyDefinitionDataSource{}
)

func NewIPv6ACLPolicyDefinitionDataSource() datasource.DataSource {
	return &IPv6ACLPolicyDefinitionDataSource{}
}
...
func (d *IPv6ACLPolicyDefinitionDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ipv6_acl_policy_definition"
}

func (d *IPv6ACLPolicyDefinitionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the IPv6 ACL Policy Definition .",
							...
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									...
									"next_header": schema.Int64Attribute{
										MarkdownDescription: "Next header",
										Computed:            true,
									},
									...
									"destination_data_ipv6_prefix_list_id": schema.StringAttribute{
										MarkdownDescription: "Destination dataIPv6 prefix list ID",
										Computed:            true,
									},
...
func (d *IPv6ACLPolicyDefinitionDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *IPv6ACLPolicyDefinitionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config IPv6ACLPolicyDefinition
