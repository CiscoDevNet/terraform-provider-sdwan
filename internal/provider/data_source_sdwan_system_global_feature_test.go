...
func TestAccDataSourceSdwanSystemGlobalProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_global_feature.test", "etherchannel_vlan_load_balance", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_global_feature.test", "bgp_community_new_format", "true"))
