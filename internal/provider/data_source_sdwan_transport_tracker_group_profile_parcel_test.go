...
func TestAccDataSourceSdwanTransportTrackerGroupProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_tracker_group_profile_parcel.test", "tracker_elements.0.tracker_id", "615d948f-34ee-4a2e-810e-a9bd8d3d48ec"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_tracker_group_profile_parcel.test", "tracker_boolean", "or"))
...
func testAccDataSourceSdwanTransportTrackerGroupProfileParcelConfig() string {
	...
	config += `
		data "sdwan_transport_tracker_group_profile_parcel" "test" {
			id = sdwan_transport_tracker_group_profile_parcel.test.id
			feature_profile_id = sdwan_transport_feature_profile.test.id1
		}
	`
	return config
}
