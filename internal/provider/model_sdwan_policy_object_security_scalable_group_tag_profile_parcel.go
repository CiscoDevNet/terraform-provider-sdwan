...
type PolicyObjectSecurityScalableGroupTag struct {
	Id               types.String                                  `tfsdk:"id"`
	Version          types.Int64                                   `tfsdk:"version"`
	Name             types.String                                  `tfsdk:"name"`
	Description      types.String                                  `tfsdk:"description"`
	FeatureProfileId types.String                                  `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectSecurityScalableGroupTagEntries `tfsdk:"entries"`
}

type PolicyObjectSecurityScalableGroupTagEntries struct {
...
func (data PolicyObjectSecurityScalableGroupTag) getModel() string {
	return "policy_object_security_scalable_group_tag"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectSecurityScalableGroupTag) getPath() string {
...
func (data PolicyObjectSecurityScalableGroupTag) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectSecurityScalableGroupTag) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectSecurityScalableGroupTagEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectSecurityScalableGroupTagEntries{}
...
func (data *PolicyObjectSecurityScalableGroupTag) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectSecurityScalableGroupTag) isNull(ctx context.Context, res gjson.Result) bool {
