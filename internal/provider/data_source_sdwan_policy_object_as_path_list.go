...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectASPathListProfileParcelDataSource{}
)
...
func (d *PolicyObjectASPathListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
