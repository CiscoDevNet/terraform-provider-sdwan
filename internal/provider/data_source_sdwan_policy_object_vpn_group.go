...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectVPNGroupProfileParcelDataSource{}
)
...
func (d *PolicyObjectVPNGroupProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
