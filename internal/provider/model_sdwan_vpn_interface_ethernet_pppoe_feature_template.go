...
type VPNInterfaceEthernetPPPoE struct {
	...
	ChapPasswordVariable                 types.String                             `tfsdk:"chap_password_variable"`
	...
	PapOutboundPassword                  types.String                             `tfsdk:"pap_outbound_password"`
	PapOutboundPasswordVariable          types.String                             `tfsdk:"pap_outbound_password_variable"`
	...
	Encapsulation                        []VPNInterfaceEthernetPPPoEEncapsulation `tfsdk:"encapsulation"`
	...
	PortForward                          []VPNInterfaceEthernetPPPoEPortForward   `tfsdk:"port_forward"`
	...
	AccessList                           []VPNInterfaceEthernetPPPoEAccessList    `tfsdk:"access_list"`
	Policer                              []VPNInterfaceEthernetPPPoEPolicer       `tfsdk:"policer"`
...
type VPNInterfaceEthernetPPPoEEncapsulation struct {
...
type VPNInterfaceEthernetPPPoEPortForward struct {
	Optional                 types.Bool   `tfsdk:"optional"`
...
type VPNInterfaceEthernetPPPoEAccessList struct {
	Optional        types.Bool   `tfsdk:"optional"`
...
type VPNInterfaceEthernetPPPoEPolicer struct {
	Optional    types.Bool   `tfsdk:"optional"`
	Direction   types.String `tfsdk:"direction"`
...
func (data VPNInterfaceEthernetPPPoE) toBody(ctx context.Context) string {
	...
	if !data.ChapPasswordVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"ppp.chap.password.ppp-auth-password."+"vipVariableName", data.ChapPasswordVariable.ValueString())
	} else if data.ChapPassword.IsNull() {
		...
		body, _ = sjson.Set(body, path+"ppp.chap.password.ppp-auth-password."+"vipValue", data.ChapPassword.ValueString())
	}
	...
	if !data.PapOutboundPasswordVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"ppp.pap.sent-username.username.ppp-auth-password."+"vipVariableName", data.PapOutboundPasswordVariable.ValueString())
	} else if data.PapOutboundPassword.IsNull() {
		body, _ = sjson.Set(body, path+"ppp.pap.sent-username.username", map[string]interface{}{})
	} else {
		body, _ = sjson.Set(body, path+"ppp.pap.sent-username.username.ppp-auth-password."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ppp.pap.sent-username.username.ppp-auth-password."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"ppp.pap.sent-username.username.ppp-auth-password."+"vipValue", data.PapOutboundPassword.ValueString())
	}
...
func (data *VPNInterfaceEthernetPPPoE) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "ppp.chap.password.ppp-auth-password.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.ChapPassword = types.StringNull()

			v := res.Get(path + "ppp.chap.password.ppp-auth-password.vipVariableName")
			data.ChapPasswordVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.ChapPassword = types.StringNull()
			data.ChapPasswordVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ppp.chap.password.ppp-auth-password.vipValue")
			data.ChapPassword = types.StringValue(v.String())
			data.ChapPasswordVariable = types.StringNull()
		}
	} else {
		data.ChapPassword = types.StringNull()
	...
	if value := res.Get(path + "ppp.pap.sent-username.username.ppp-auth-password.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.PapOutboundPassword = types.StringNull()

			v := res.Get(path + "ppp.pap.sent-username.username.ppp-auth-password.vipVariableName")
			data.PapOutboundPasswordVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.PapOutboundPassword = types.StringNull()
			data.PapOutboundPasswordVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ppp.pap.sent-username.username.ppp-auth-password.vipValue")
			data.PapOutboundPassword = types.StringValue(v.String())
			data.PapOutboundPasswordVariable = types.StringNull()
		}
	} else {
		data.PapOutboundPassword = types.StringNull()
	...
	if value := res.Get(path + "tunnel-interface.encapsulation.vipValue"); len(value.Array()) > 0 {
		data.Encapsulation = make([]VPNInterfaceEthernetPPPoEEncapsulation, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoEEncapsulation{}
	...
	if value := res.Get(path + "nat.port-forward.vipValue"); len(value.Array()) > 0 {
		data.PortForward = make([]VPNInterfaceEthernetPPPoEPortForward, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoEPortForward{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
	...
	if value := res.Get(path + "access-list.vipValue"); len(value.Array()) > 0 {
		data.AccessList = make([]VPNInterfaceEthernetPPPoEAccessList, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoEAccessList{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
	...
	if value := res.Get(path + "policer.vipValue"); len(value.Array()) > 0 {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoEPolicer{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
...
func (data *VPNInterfaceEthernetPPPoE) hasChanges(ctx context.Context, state *VPNInterfaceEthernetPPPoE) bool {
	...
	if !data.ChapPassword.Equal(state.ChapPassword) {
		hasChanges = true
	}
	...
	if !data.PapOutboundPassword.Equal(state.PapOutboundPassword) {
		hasChanges = true
	}
