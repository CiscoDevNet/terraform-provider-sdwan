...
func (data VPNInterfaceEthernetPPPoE) getModel() string {
	return "vpn-interface-ethpppoe"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin toBody
func (data VPNInterfaceEthernetPPPoE) toBody(ctx context.Context) string {
	body := ""
	...
	body, _ = sjson.Set(body, "templateType", "vpn-interface-ethpppoe")
	...
	if !data.IpMtuForDialerInterfaceVariable.IsNull() {
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipType", "variableName")
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipVariableName", data.IpMtuForDialerInterfaceVariable.ValueString())
	} else if data.IpMtuForDialerInterface.IsNull() {
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"dialer-ip-mtu."+"vipValue", data.IpMtuForDialerInterface.ValueInt64())
	}

	if !data.DialerTcpMssVariable.IsNull() {
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipType", "variableName")
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipVariableName", data.DialerTcpMssVariable.ValueString())
	} else if data.DialerTcpMss.IsNull() {
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"dialer-tcp-mss-adjust."+"vipValue", data.DialerTcpMss.ValueInt64())
	}
...
func (data *VPNInterfaceEthernetPPPoE) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "tunnel-interface.encapsulation.vipValue"); len(value.Array()) > 0 {
		data.TunnelInterfaceEncapsulations = make([]VPNInterfaceEthernetPPPoETunnelInterfaceEncapsulations, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoETunnelInterfaceEncapsulations{}
		...
		if len(data.TunnelInterfaceEncapsulations) > 0 {
			data.TunnelInterfaceEncapsulations = []VPNInterfaceEthernetPPPoETunnelInterfaceEncapsulations{}
		}
	}
	...
	if value := res.Get(path + "nat.port-forward.vipValue"); len(value.Array()) > 0 {
		data.NatPortForwards = make([]VPNInterfaceEthernetPPPoENatPortForwards, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoENatPortForwards{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.NatPortForwards) > 0 {
			data.NatPortForwards = []VPNInterfaceEthernetPPPoENatPortForwards{}
		}
	}
	...
	if value := res.Get(path + "access-list.vipValue"); len(value.Array()) > 0 {
		data.AccessLists = make([]VPNInterfaceEthernetPPPoEAccessLists, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoEAccessLists{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.AccessLists) > 0 {
			data.AccessLists = []VPNInterfaceEthernetPPPoEAccessLists{}
		}
	}
	if value := res.Get(path + "policer.vipValue"); len(value.Array()) > 0 {
		data.Policers = make([]VPNInterfaceEthernetPPPoEPolicers, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceEthernetPPPoEPolicers{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.Policers) > 0 {
			data.Policers = []VPNInterfaceEthernetPPPoEPolicers{}
		}
	}
	if value := res.Get(path + "dialer-ip-mtu.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.IpMtuForDialerInterface = types.Int64Null()

			v := res.Get(path + "dialer-ip-mtu.vipVariableName")
			data.IpMtuForDialerInterfaceVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.IpMtuForDialerInterface = types.Int64Null()
			data.IpMtuForDialerInterfaceVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "dialer-ip-mtu.vipValue")
			data.IpMtuForDialerInterface = types.Int64Value(v.Int())
			data.IpMtuForDialerInterfaceVariable = types.StringNull()
		}
	} else {
		data.IpMtuForDialerInterface = types.Int64Null()
	...
	if value := res.Get(path + "dialer-tcp-mss-adjust.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.DialerTcpMss = types.Int64Null()

			v := res.Get(path + "dialer-tcp-mss-adjust.vipVariableName")
			data.DialerTcpMssVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.DialerTcpMss = types.Int64Null()
			data.DialerTcpMssVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "dialer-tcp-mss-adjust.vipValue")
			data.DialerTcpMss = types.Int64Value(v.Int())
			data.DialerTcpMssVariable = types.StringNull()
		}
	} else {
		data.DialerTcpMss = types.Int64Null()
...
func (data *VPNInterfaceEthernetPPPoE) hasChanges(ctx context.Context, state *VPNInterfaceEthernetPPPoE) bool {
	hasChanges := false
	...
	if !data.IpMtuForDialerInterface.Equal(state.IpMtuForDialerInterface) {
		hasChanges = true
	}
	if !data.DialerTcpMss.Equal(state.DialerTcpMss) {
		hasChanges = true
	}
