...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &EmbeddedSecurityProfileParcelDataSource{}
)
...
func (d *EmbeddedSecurityProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
