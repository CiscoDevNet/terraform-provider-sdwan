...
func TestAccDataSourceSdwanTransportRoutingBGPProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_bgp_profile_parcel.test", "compare_med", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_routing_bgp_profile_parcel.test", "ipv6_network.0.network_prefix", "2001:0DB8:0000:000b::/64"))
