...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectDataIPv6PrefixListProfileParcelDataSource{}
)
...
func (d *PolicyObjectDataIPv6PrefixListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
