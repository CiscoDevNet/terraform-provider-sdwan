...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &DNSSecurityProfileParcelDataSource{}
)
...
func (d *DNSSecurityProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
