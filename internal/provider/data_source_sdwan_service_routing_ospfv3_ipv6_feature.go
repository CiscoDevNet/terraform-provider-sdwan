...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceRoutingOSPFv3IPv6ProfileParcelDataSource{}
)
...
func (d *ServiceRoutingOSPFv3IPv6ProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
