...
func TestAccDataSourceSdwanSystemMRFProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_mrf_profile_parcel.test", "secondary_region", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_mrf_profile_parcel.test", "role", "edge-router"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_mrf_profile_parcel.test", "enable_mrf_migration", "enabled"))
