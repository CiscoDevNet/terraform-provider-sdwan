...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportManagementVPNProfileParcelDataSource{}
)
...
func (d *TransportManagementVPNProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
