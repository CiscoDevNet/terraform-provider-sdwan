...
func TestAccDataSourceSdwanPolicyObjectDataPrefixProfileParcel(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanPolicyObjectDataPrefixPrerequisitesProfileParcelConfig + testAccDataSourceSdwanPolicyObjectDataPrefixProfileParcelConfig(),
...
const testAccDataSourceSdwanPolicyObjectDataPrefixPrerequisitesProfileParcelConfig = `
