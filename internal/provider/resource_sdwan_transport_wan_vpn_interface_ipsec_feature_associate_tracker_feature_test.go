...
func TestAccSdwanTransportWANVPNInterfaceIPSECFeatureAssociateTrackerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanTransportWANVPNInterfaceIPSECFeatureAssociateTrackerFeaturePrerequisitesConfig + testAccSdwanTransportWANVPNInterfaceIPSECFeatureAssociateTrackerFeatureConfig_all(),
...
const testAccSdwanTransportWANVPNInterfaceIPSECFeatureAssociateTrackerFeaturePrerequisitesConfig = `
...
func testAccSdwanTransportWANVPNInterfaceIPSECFeatureAssociateTrackerFeatureConfig_all() string {
