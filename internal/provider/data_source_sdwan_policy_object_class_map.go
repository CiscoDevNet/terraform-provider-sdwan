...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectClassMapProfileParcelDataSource{}
)
...
func (d *PolicyObjectClassMapProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
