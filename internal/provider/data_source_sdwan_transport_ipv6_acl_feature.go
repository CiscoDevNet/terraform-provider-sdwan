...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportIPv6ACLProfileParcelDataSource{}
)
...
func (d *TransportIPv6ACLProfileParcelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Transport IPv6 ACL Feature.",
...
func (d *TransportIPv6ACLProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
