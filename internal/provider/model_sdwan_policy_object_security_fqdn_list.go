...
func (data *PolicyObjectSecurityFQDNList) fromBody(ctx context.Context, res gjson.Result, fullRead bool) {
	...
	if !fullRead {
		resultEntries := make([]PolicyObjectSecurityFQDNListEntries, 0, len(data.Entries))
