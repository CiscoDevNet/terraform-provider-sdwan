...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceRoutingOSPFProfileParcelDataSource{}
)
...
func (d *ServiceRoutingOSPFProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
