...
var (
	_ datasource.DataSource              = &SecurityAppHostingFeatureTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &SecurityAppHostingFeatureTemplateDataSource{}
)

func NewSecurityAppHostingFeatureTemplateDataSource() datasource.DataSource {
	return &SecurityAppHostingFeatureTemplateDataSource{}
}
...
func (d *SecurityAppHostingFeatureTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_security_app_hosting_feature_template"
}

func (d *SecurityAppHostingFeatureTemplateDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Security App Hosting feature template.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"nat": schema.BoolAttribute{
							MarkdownDescription: "Is Nat enabled",
							Computed:            true,
						},
						...
						"database_url": schema.BoolAttribute{
							MarkdownDescription: "Download URL Database on Device",
							Computed:            true,
						},
						...
						"service_gateway_ip": schema.StringAttribute{
							MarkdownDescription: "Service Gateway IP (Management interface)",
							Computed:            true,
						},
						...
						"service_ip": schema.StringAttribute{
							MarkdownDescription: "Service IP",
							Computed:            true,
						},
						...
						"data_gateway_ip": schema.StringAttribute{
							MarkdownDescription: "Data Gateway IP ",
							Computed:            true,
						},
						...
						"data_service_ip": schema.StringAttribute{
							MarkdownDescription: "Data Service IP",
							Computed:            true,
						},
...
func (d *SecurityAppHostingFeatureTemplateDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *SecurityAppHostingFeatureTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SecurityAppHostingFeatureTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config SecurityAppHosting
