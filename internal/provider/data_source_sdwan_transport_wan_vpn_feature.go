...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportWANVPNProfileParcelDataSource{}
)
...
func (d *TransportWANVPNProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
