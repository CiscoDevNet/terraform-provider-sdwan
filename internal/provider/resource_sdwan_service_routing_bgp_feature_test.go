...
func TestAccSdwanServiceRoutingBGPProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_bgp_feature.test", "ipv4_neighbors.0.address_families.0.restart_max_number_of_prefixes", "2000"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_bgp_feature.test", "ipv4_neighbors.0.address_families.0.restart_threshold", "75"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_bgp_feature.test", "ipv6_neighbors.0.address_families.0.restart_max_number_of_prefixes", "2000"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_routing_bgp_feature.test", "ipv6_neighbors.0.address_families.0.restart_threshold", "75"))
