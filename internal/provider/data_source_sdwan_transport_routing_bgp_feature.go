...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportRoutingBGPProfileParcelDataSource{}
)
...
func (d *TransportRoutingBGPProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
