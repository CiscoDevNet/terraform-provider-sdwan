...
func TestAccSdwanServiceLANVPNInterfaceIPSECProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "interface_address", "9.7.5.4"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "mask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "tunnel_source_address", "1.3.5.88"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "tunnel_source_mask", "255.255.255.0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "tunnel_destination_address", "2.55.67.99"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "tunnel_destination_mask", "255.255.255.0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "preshared_key_for_ike", "123"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "ike_id_for_local_end_point", "xxx"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ipsec_profile_parcel.test", "ike_id_for_remote_end_point", "xxx"))
