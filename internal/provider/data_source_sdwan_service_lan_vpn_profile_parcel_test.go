...
func TestAccDataSourceSdwanServiceLANVPNProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "dns_primary_ipv4_address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "dns_secondary_ipv4_address", "2.3.4.5"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "dns_primary_ipv6_address", "2001:0:0:1::0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "dns_secondary_ipv6_address", "2001:0:0:2::0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "ipv6_routes.0.prefix", "2001:0:0:1::0/12"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "ipv6_routes.0.next_hops.0.address", "2001:0:0:1::0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "ipv6_routes.0.next_hops.0.administrative_distance", "1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "nat_64_v4_pool.0.nat64_v4_pool_name", "NATPOOL1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "nat_64_v4_pool.0.nat64_v4_pool_range_start", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "nat_64_v4_pool.0.nat64_v4_pool_range_end", "2.3.4.5"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_lan_vpn_profile_parcel.test", "nat_64_v4_pool.0.overload", "false"))
