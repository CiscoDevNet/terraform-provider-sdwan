...
func TestAccSdwanServiceLANVPNInterfaceEthernetProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ethernet_profile_parcel.test", "ipv6_vrrps.0.addresses.0.link_local_address", "1::1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_lan_vpn_interface_ethernet_profile_parcel.test", "ipv6_vrrps.0.addresses.0.global_address", "1::1/24"))
