...
func TestAccSdwanPolicyObjectASPathListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_as_path_list_profile_parcel.test", "as_path_list_id", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_as_path_list_profile_parcel.test", "entries.0.as_path_list", "110"))
