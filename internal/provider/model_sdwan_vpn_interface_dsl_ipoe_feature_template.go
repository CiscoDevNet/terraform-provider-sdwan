...
func (data VPNInterfaceDSLIPoE) getModel() string {
	return "vpn-interface-ipoe"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin toBody
func (data VPNInterfaceDSLIPoE) toBody(ctx context.Context) string {
	body := ""
	...
	body, _ = sjson.Set(body, "templateType", "vpn-interface-ipoe")
	...
	if !data.EthernetIpv4AddressVariable.IsNull() {
		body, _ = sjson.Set(body, path+"ip.address."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.address."+"vipType", "variableName")
		body, _ = sjson.Set(body, path+"ip.address."+"vipVariableName", data.EthernetIpv4AddressVariable.ValueString())
	} else if data.EthernetIpv4Address.IsNull() {
		body, _ = sjson.Set(body, path+"ip.address."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.address."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"ip.address."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.address."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"ip.address."+"vipValue", data.EthernetIpv4Address.ValueString())
	}

	if !data.EthernetEnableDhcpVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"ip.dhcp-client."+"vipVariableName", data.EthernetEnableDhcpVariable.ValueString())
	} else if data.EthernetEnableDhcp.IsNull() {
		body, _ = sjson.Set(body, path+"ip.dhcp-client."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.dhcp-client."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"ip.dhcp-client."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.dhcp-client."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"ip.dhcp-client."+"vipValue", strconv.FormatBool(data.EthernetEnableDhcp.ValueBool()))
	}

	if !data.EthernetDhcpDistanceVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"ip.dhcp-distance."+"vipVariableName", data.EthernetDhcpDistanceVariable.ValueString())
	} else if data.EthernetDhcpDistance.IsNull() {
		body, _ = sjson.Set(body, path+"ip.dhcp-distance."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.dhcp-distance."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"ip.dhcp-distance."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.dhcp-distance."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"ip.dhcp-distance."+"vipValue", data.EthernetDhcpDistance.ValueInt64())
	}

	if !data.EthernetDhcpHelperVariable.IsNull() {
		body, _ = sjson.Set(body, path+"dhcp-helper."+"vipObjectType", "list")
		body, _ = sjson.Set(body, path+"dhcp-helper."+"vipType", "variableName")
		body, _ = sjson.Set(body, path+"dhcp-helper."+"vipVariableName", data.EthernetDhcpHelperVariable.ValueString())
	} else if data.EthernetDhcpHelper.IsNull() {
		body, _ = sjson.Set(body, path+"dhcp-helper."+"vipObjectType", "list")
		...
		var values []string
		data.EthernetDhcpHelper.ElementsAs(ctx, &values, false)
		body, _ = sjson.Set(body, path+"dhcp-helper."+"vipValue", values)
	}
	if data.InternalControllerType.IsNull() {
	} else {
		body, _ = sjson.Set(body, path+"controller-type."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"controller-type."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"controller-type."+"vipValue", data.InternalControllerType.ValueString())
	}
	...
	if !data.EncapVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"bridge-dot1q.encap."+"vipVariableName", data.EncapVariable.ValueString())
	} else if data.Encap.IsNull() {
		body, _ = sjson.Set(body, path+"bridge-dot1q.encap."+"vipObjectType", "object")
		...
		body, _ = sjson.Set(body, path+"bridge-dot1q.encap."+"vipValue", data.Encap.ValueInt64())
	}

	if !data.DialerPoolNumberVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"pppoe-client.dial-pool-number."+"vipValue", data.DialerPoolNumber.ValueInt64())
	}

	if !data.PppMaximumPayloadVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"pppoe-client.ppp-max-payload."+"vipVariableName", data.PppMaximumPayloadVariable.ValueString())
	} else if data.PppMaximumPayload.IsNull() {
		body, _ = sjson.Set(body, path+"pppoe-client.ppp-max-payload."+"vipObjectType", "object")
		...
		body, _ = sjson.Set(body, path+"pppoe-client.ppp-max-payload."+"vipValue", data.PppMaximumPayload.ValueInt64())
	}

	if !data.DialerAddressNegotiatedVariable.IsNull() {
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipObjectType", "node-only")
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipType", "variableName")
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipVariableName", data.DialerAddressNegotiatedVariable.ValueString())
	} else if data.DialerAddressNegotiated.IsNull() {
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipObjectType", "node-only")
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipObjectType", "node-only")
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"ip.address-negotiated."+"vipValue", strconv.FormatBool(data.DialerAddressNegotiated.ValueBool()))
	}

	if !data.UnnumberedLoopbackInterfaceVariable.IsNull() {
		...
		body, _ = sjson.Set(body, path+"ip.unnumbered."+"vipVariableName", data.UnnumberedLoopbackInterfaceVariable.ValueString())
	} else if data.UnnumberedLoopbackInterface.IsNull() {
		body, _ = sjson.Set(body, path+"ip.unnumbered."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.unnumbered."+"vipType", "ignore")
	} else {
		body, _ = sjson.Set(body, path+"ip.unnumbered."+"vipObjectType", "object")
		body, _ = sjson.Set(body, path+"ip.unnumbered."+"vipType", "constant")
		body, _ = sjson.Set(body, path+"ip.unnumbered."+"vipValue", data.UnnumberedLoopbackInterface.ValueString())
	}
...
func (data *VPNInterfaceDSLIPoE) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "ip.address.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.EthernetIpv4Address = types.StringNull()

			v := res.Get(path + "ip.address.vipVariableName")
			data.EthernetIpv4AddressVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.EthernetIpv4Address = types.StringNull()
			data.EthernetIpv4AddressVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ip.address.vipValue")
			data.EthernetIpv4Address = types.StringValue(v.String())
			data.EthernetIpv4AddressVariable = types.StringNull()
		}
	} else {
		data.EthernetIpv4Address = types.StringNull()
	...
	if value := res.Get(path + "ip.dhcp-client.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.EthernetEnableDhcp = types.BoolNull()

			v := res.Get(path + "ip.dhcp-client.vipVariableName")
			data.EthernetEnableDhcpVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.EthernetEnableDhcp = types.BoolNull()
			data.EthernetEnableDhcpVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ip.dhcp-client.vipValue")
			data.EthernetEnableDhcp = types.BoolValue(v.Bool())
			data.EthernetEnableDhcpVariable = types.StringNull()
		}
	} else {
		data.EthernetEnableDhcp = types.BoolNull()
	...
	if value := res.Get(path + "ip.dhcp-distance.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.EthernetDhcpDistance = types.Int64Null()

			v := res.Get(path + "ip.dhcp-distance.vipVariableName")
			data.EthernetDhcpDistanceVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.EthernetDhcpDistance = types.Int64Null()
			data.EthernetDhcpDistanceVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ip.dhcp-distance.vipValue")
			data.EthernetDhcpDistance = types.Int64Value(v.Int())
			data.EthernetDhcpDistanceVariable = types.StringNull()
		}
	} else {
		data.EthernetDhcpDistance = types.Int64Null()
	...
	if value := res.Get(path + "dhcp-helper.vipType"); len(value.Array()) > 0 {
		if value.String() == "variableName" {
			data.EthernetDhcpHelper = types.SetNull(types.StringType)

			v := res.Get(path + "dhcp-helper.vipVariableName")
			data.EthernetDhcpHelperVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.EthernetDhcpHelper = types.SetNull(types.StringType)
			data.EthernetDhcpHelperVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "dhcp-helper.vipValue")
			data.EthernetDhcpHelper = helpers.GetStringSet(v.Array())
			data.EthernetDhcpHelperVariable = types.StringNull()
		}
	} else {
		data.EthernetDhcpHelper = types.SetNull(types.StringType)
	...
	if value := res.Get(path + "controller-type.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.InternalControllerType = types.StringNull()

		} else if value.String() == "ignore" {
			data.InternalControllerType = types.StringNull()

		} else if value.String() == "constant" {
			v := res.Get(path + "controller-type.vipValue")
			data.InternalControllerType = types.StringValue(v.String())
	...
	if value := res.Get(path + "bridge-dot1q.encap.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.Encap = types.Int64Null()

			v := res.Get(path + "bridge-dot1q.encap.vipVariableName")
			data.EncapVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.Encap = types.Int64Null()
			data.EncapVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "bridge-dot1q.encap.vipValue")
			data.Encap = types.Int64Value(v.Int())
			data.EncapVariable = types.StringNull()
		}
	} else {
		data.Encap = types.Int64Null()
	...
	if value := res.Get(path + "pppoe-client.dial-pool-number.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.DialerPoolNumber = types.Int64Null()

			v := res.Get(path + "pppoe-client.dial-pool-number.vipVariableName")
			data.DialerPoolNumberVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.DialerPoolNumber = types.Int64Null()
			data.DialerPoolNumberVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "pppoe-client.dial-pool-number.vipValue")
			data.DialerPoolNumber = types.Int64Value(v.Int())
			data.DialerPoolNumberVariable = types.StringNull()
		}
	} else {
		data.DialerPoolNumber = types.Int64Null()
	...
	if value := res.Get(path + "pppoe-client.ppp-max-payload.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.PppMaximumPayload = types.Int64Null()

			v := res.Get(path + "pppoe-client.ppp-max-payload.vipVariableName")
			data.PppMaximumPayloadVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.PppMaximumPayload = types.Int64Null()
			data.PppMaximumPayloadVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "pppoe-client.ppp-max-payload.vipValue")
			data.PppMaximumPayload = types.Int64Value(v.Int())
			data.PppMaximumPayloadVariable = types.StringNull()
		}
	} else {
		data.PppMaximumPayload = types.Int64Null()
	...
	if value := res.Get(path + "ip.address-negotiated.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.DialerAddressNegotiated = types.BoolNull()

			v := res.Get(path + "ip.address-negotiated.vipVariableName")
			data.DialerAddressNegotiatedVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.DialerAddressNegotiated = types.BoolNull()
			data.DialerAddressNegotiatedVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ip.address-negotiated.vipValue")
			data.DialerAddressNegotiated = types.BoolValue(v.Bool())
			data.DialerAddressNegotiatedVariable = types.StringNull()
		}
	} else {
		data.DialerAddressNegotiated = types.BoolNull()
	...
	if value := res.Get(path + "ip.unnumbered.vipType"); value.Exists() {
		if value.String() == "variableName" {
			data.UnnumberedLoopbackInterface = types.StringNull()

			v := res.Get(path + "ip.unnumbered.vipVariableName")
			data.UnnumberedLoopbackInterfaceVariable = types.StringValue(v.String())

		} else if value.String() == "ignore" {
			data.UnnumberedLoopbackInterface = types.StringNull()
			data.UnnumberedLoopbackInterfaceVariable = types.StringNull()
		} else if value.String() == "constant" {
			v := res.Get(path + "ip.unnumbered.vipValue")
			data.UnnumberedLoopbackInterface = types.StringValue(v.String())
			data.UnnumberedLoopbackInterfaceVariable = types.StringNull()
		}
	} else {
		data.UnnumberedLoopbackInterface = types.StringNull()
	...
	if value := res.Get(path + "tunnel-interface.encapsulation.vipValue"); len(value.Array()) > 0 {
		data.TunnelInterfaceEncapsulations = make([]VPNInterfaceDSLIPoETunnelInterfaceEncapsulations, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceDSLIPoETunnelInterfaceEncapsulations{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.TunnelInterfaceEncapsulations) > 0 {
			data.TunnelInterfaceEncapsulations = []VPNInterfaceDSLIPoETunnelInterfaceEncapsulations{}
		}
	}
	...
	if value := res.Get(path + "nat.port-forward.vipValue"); len(value.Array()) > 0 {
		data.NatPortForwards = make([]VPNInterfaceDSLIPoENatPortForwards, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceDSLIPoENatPortForwards{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.NatPortForwards) > 0 {
			data.NatPortForwards = []VPNInterfaceDSLIPoENatPortForwards{}
		}
	}
	...
	if value := res.Get(path + "access-list.vipValue"); len(value.Array()) > 0 {
		data.AccessLists = make([]VPNInterfaceDSLIPoEAccessLists, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceDSLIPoEAccessLists{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.AccessLists) > 0 {
			data.AccessLists = []VPNInterfaceDSLIPoEAccessLists{}
		}
	}
	if value := res.Get(path + "policer.vipValue"); len(value.Array()) > 0 {
		data.Policers = make([]VPNInterfaceDSLIPoEPolicers, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := VPNInterfaceDSLIPoEPolicers{}
			if cValue := v.Get("vipOptional"); cValue.Exists() {
				item.Optional = types.BoolValue(cValue.Bool())
			} else {
				item.Optional = types.BoolNull()
		...
		if len(data.Policers) > 0 {
			data.Policers = []VPNInterfaceDSLIPoEPolicers{}
		}
	}
...
func (data *VPNInterfaceDSLIPoE) hasChanges(ctx context.Context, state *VPNInterfaceDSLIPoE) bool {
	hasChanges := false
	if !data.EthernetInterfaceName.Equal(state.EthernetInterfaceName) {
		hasChanges = true
	}
	if !data.EthernetIpv4Address.Equal(state.EthernetIpv4Address) {
		hasChanges = true
	}
	if !data.EthernetEnableDhcp.Equal(state.EthernetEnableDhcp) {
		hasChanges = true
	}
	if !data.EthernetDhcpDistance.Equal(state.EthernetDhcpDistance) {
		hasChanges = true
	}
	if !data.EthernetDhcpHelper.Equal(state.EthernetDhcpHelper) {
		hasChanges = true
	}
	if !data.InternalControllerType.Equal(state.InternalControllerType) {
		hasChanges = true
	}
	...
	if !data.Encap.Equal(state.Encap) {
		hasChanges = true
	}
	if !data.DialerPoolNumber.Equal(state.DialerPoolNumber) {
		hasChanges = true
	}
	if !data.PppMaximumPayload.Equal(state.PppMaximumPayload) {
		hasChanges = true
	}
	if !data.DialerAddressNegotiated.Equal(state.DialerAddressNegotiated) {
		hasChanges = true
	}
	if !data.UnnumberedLoopbackInterface.Equal(state.UnnumberedLoopbackInterface) {
		hasChanges = true
	}
