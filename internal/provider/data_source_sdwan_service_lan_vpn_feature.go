...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &ServiceLANVPNProfileParcelDataSource{}
)
...
func (d *ServiceLANVPNProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
