...
func TestAccDataSourceSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeaturePrerequisitesConfig + testAccDataSourceSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeatureConfig(),
...
const testAccDataSourceSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeaturePrerequisitesConfig = `
...
func testAccDataSourceSdwanTransportWANVPNInterfaceCellularFeatureAssociateTrackerGroupFeatureConfig() string {
	config := ""
	config += `resource "sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature" "test" {` + "\n"
	...
	config += `
		data "sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature" "test" {
			feature_profile_id = sdwan_transport_feature_profile.test.id
			transport_wan_vpn_feature_id = sdwan_transport_wan_vpn_feature.test.id
			transport_wan_vpn_interface_cellular_feature_id = sdwan_transport_wan_vpn_interface_cellular_feature.test.id
			id = sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature.test.id
		}
	`
	return config
}
