...
func TestAccSdwanSystemMRFProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_mrf_feature.test", "enable_management_region", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_mrf_feature.test", "vrf_id", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_mrf_feature.test", "management_gateway", "false"))
