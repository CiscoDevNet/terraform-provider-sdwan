...
func TestAccSdwanSystemMRFProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_mrf_feature.test", "enable_management_region", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_system_mrf_feature.test", "vrf_id", "1"))
