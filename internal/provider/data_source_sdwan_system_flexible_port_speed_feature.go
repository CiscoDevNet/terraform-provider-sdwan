...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemFlexiblePortSpeedProfileParcelDataSource{}
)
...
func (d *SystemFlexiblePortSpeedProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
