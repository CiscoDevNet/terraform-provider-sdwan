...
func TestAccDataSourceSdwanSystemSecurityProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_security_profile_parcel.test", "key.0.id", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_security_profile_parcel.test", "key.0.name", "aaa"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_security_profile_parcel.test", "key.0.send_id", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_system_security_profile_parcel.test", "key.0.receiver_id", "2"))
