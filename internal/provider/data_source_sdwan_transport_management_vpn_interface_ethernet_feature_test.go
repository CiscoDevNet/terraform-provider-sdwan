...
func TestAccDataSourceSdwanTransportManagementVPNInterfaceEthernetProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_feature.test", "ipv4_address_type", "static"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_management_vpn_interface_ethernet_feature.test", "ipv6_address_type", "static"))
