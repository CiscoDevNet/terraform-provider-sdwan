...
func TestAccDataSourceSdwanServiceIPv6ACLProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.conditions.0.next_header", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.conditions.0.packet_length", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.conditions.0.source_ports.0.port", "8000"))
