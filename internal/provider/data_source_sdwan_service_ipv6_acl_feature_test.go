...
func TestAccDataSourceSdwanServiceIPv6ACLProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "default_action", "drop"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.sequence_id", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.sequence_name", "AccessControlList1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.match_entries.0.next_header", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.match_entries.0.packet_length", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.match_entries.0.source_ports.0.port", "8000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_ipv6_acl_feature.test", "sequences.0.match_entries.0.tcp_state", "syn"))
...
func testAccDataSourceSdwanServiceIPv6ACLProfileParcelConfig() string {
	...
	config += `
		data "sdwan_service_ipv6_acl_feature" "test" {
			id = sdwan_service_ipv6_acl_feature.test.id
