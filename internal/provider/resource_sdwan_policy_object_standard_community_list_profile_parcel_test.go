...
func TestAccSdwanPolicyObjectStandardCommunityListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_policy_object_standard_community_list_profile_parcel.test", "entries.0.standard_community", "1000:10000"))
