...
var (
	_ datasource.DataSource                     = &EmbeddedSecurityNGFWProfileParcelDataSource{}
	_ datasource.DataSourceWithConfigure        = &EmbeddedSecurityNGFWProfileParcelDataSource{}
	_ datasource.DataSourceWithConfigValidators = &EmbeddedSecurityNGFWProfileParcelDataSource{}
)

func NewEmbeddedSecurityNGFWProfileParcelDataSource() datasource.DataSource {
	return &EmbeddedSecurityNGFWProfileParcelDataSource{}
}

type EmbeddedSecurityNGFWProfileParcelDataSource struct {
	client *sdwan.Client
}

func (d *EmbeddedSecurityNGFWProfileParcelDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_embedded_security_ngfw_policy"
}

func (d *EmbeddedSecurityNGFWProfileParcelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Embedded Security NGFW Policy.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"actions": schema.ListNestedAttribute{
							MarkdownDescription: "can be empty array or with type or parameter",
							Computed:            true,
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
...
func (d *EmbeddedSecurityNGFWProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
...
func (d *EmbeddedSecurityNGFWProfileParcelDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *EmbeddedSecurityNGFWProfileParcelDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config EmbeddedSecurityNGFW
