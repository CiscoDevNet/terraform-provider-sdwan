...
func TestAccSdwanEmbeddedSecurityNGFWProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_embedded_security_ngfw_policy.test", "default_actione", "pass"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_embedded_security_ngfw_policy.test", "rules.0.sequence_id", "1"))
