...
func TestAccSdwanServiceLANVPNInterfaceIPSecFeatureAssociateDHCPServerFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanServiceLANVPNInterfaceIPSecFeatureAssociateDHCPServerFeaturePrerequisitesConfig + testAccSdwanServiceLANVPNInterfaceIPSecFeatureAssociateDHCPServerFeatureConfig_all(),
...
const testAccSdwanServiceLANVPNInterfaceIPSecFeatureAssociateDHCPServerFeaturePrerequisitesConfig = `
...
func testAccSdwanServiceLANVPNInterfaceIPSecFeatureAssociateDHCPServerFeatureConfig_all() string {
