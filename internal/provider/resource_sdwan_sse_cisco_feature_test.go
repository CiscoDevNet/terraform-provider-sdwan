...
func TestAccSdwanSSECiscoProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.shutdown", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.dpd_interval", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.dpd_retries", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ike_version", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ike_rekey_interval", "14400"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ike_ciphersuite", "aes256-cbc-sha1"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ike_group", "16"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ipsec_rekey_interval", "3600"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ipsec_replay_window", "512"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.ipsec_ciphersuite", "aes256-cbc-sha512"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.perfect_forward_secrecy", "group-16"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_sse_cisco_feature.test", "interfaces.0.track_enable", "true"))
