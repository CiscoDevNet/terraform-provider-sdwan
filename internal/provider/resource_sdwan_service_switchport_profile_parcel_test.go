...
func TestAccSdwanServiceSwitchportProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_service_switchport_profile_parcel.test", "static_mac_addresses.0.interface_name", "GigabitEthernet0/0/0"))
