...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &SystemBasicProfileParcelDataSource{}
)
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"port_hopping": schema.BoolAttribute{
				MarkdownDescription: "The port hop functionality is deprecated for devices 17.18 and higher. Use the full-port-hop field instead on interfaces.",
				Computed:            true,
			},
...
func (d *SystemBasicProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
