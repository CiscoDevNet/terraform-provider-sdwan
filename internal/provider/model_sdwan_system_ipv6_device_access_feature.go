...
func (data *SystemIPv6DeviceAccess) fromBody(ctx context.Context, res gjson.Result, fullRead bool) {
	...
	if !fullRead {
		resultSequences := make([]SystemIPv6DeviceAccessSequences, 0, len(data.Sequences))
