...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TransportTrackerProfileParcelDataSource{}
)
...
func (d *TransportTrackerProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
