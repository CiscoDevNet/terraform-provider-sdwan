...
func TestAccDataSourceSdwanServiceDHCPServerProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_dhcp_server_feature.test", "interface_mtu", "65535"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_dhcp_server_feature.test", "domain_name", "example.com"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_service_dhcp_server_feature.test", "default_gateway", "1.2.3.4"))
...
const testAccDataSourceSdwanServiceDHCPServerPrerequisitesProfileParcelConfig = `
...
func testAccDataSourceSdwanServiceDHCPServerProfileParcelConfig() string {
	...
	config += `
		data "sdwan_service_dhcp_server_feature" "test" {
			id = sdwan_service_dhcp_server_feature.test.id
