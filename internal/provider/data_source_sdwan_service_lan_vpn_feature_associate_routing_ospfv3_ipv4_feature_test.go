...
func TestAccDataSourceSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv4Feature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv4FeaturePrerequisitesConfig + testAccDataSourceSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv4FeatureConfig(),
...
const testAccDataSourceSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv4FeaturePrerequisitesConfig = `
...
func testAccDataSourceSdwanServiceLANVPNFeatureAssociateRoutingOSPFv3IPv4FeatureConfig() string {
	config := ""
	...
	config += `
		data "sdwan_service_lan_vpn_feature_associate_routing_ospfv3_ipv4_feature" "test" {
			feature_profile_id = sdwan_service_feature_profile.test.id
			service_lan_vpn_feature_id = sdwan_service_lan_vpn_feature.test.id
			id = sdwan_service_lan_vpn_feature_associate_routing_ospfv3_ipv4_feature.test.id
		}
	`
	return config
}
