...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectSecurityURLBlockListProfileParcelDataSource{}
)
...
func (d *PolicyObjectSecurityURLBlockListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
