...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectExtendedCommunityListProfileParcelDataSource{}
)
...
func (d *PolicyObjectExtendedCommunityListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
