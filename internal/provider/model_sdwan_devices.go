...
func (data Devices) toBody(ctx context.Context) string {
	body := ""
...
func (data *Devices) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *Devices) hasChanges(ctx context.Context, state *Devices) bool {
	hasChanges := false
