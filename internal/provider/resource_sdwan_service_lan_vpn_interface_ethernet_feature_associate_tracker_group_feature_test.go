...
func TestAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeature(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeaturePrerequisitesConfig + testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeatureConfig_all(),
...
const testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeaturePrerequisitesConfig = `
...
func testAccSdwanServiceLANVPNInterfaceEthernetFeatureAssociateTrackerGroupFeatureConfig_all() string {
