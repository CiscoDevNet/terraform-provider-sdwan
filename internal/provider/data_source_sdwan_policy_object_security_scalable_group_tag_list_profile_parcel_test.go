...
func TestAccDataSourceSdwanPolicyObjectSecurityScalableGroupTagListProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_policy_object_security_scalable_group_tag_list_profile_parcel.test", "entries.0.sgt_name", "ANY"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_policy_object_security_scalable_group_tag_list_profile_parcel.test", "entries.0.tag", "65535"))
...
func testAccDataSourceSdwanPolicyObjectSecurityScalableGroupTagListProfileParcelConfig() string {
	config := `resource "sdwan_policy_object_security_scalable_group_tag_list_profile_parcel" "test" {` + "\n"
	config += ` name = "TF_TEST"` + "\n"
	...
	config += `
		data "sdwan_policy_object_security_scalable_group_tag_list_profile_parcel" "test" {
			id = sdwan_policy_object_security_scalable_group_tag_list_profile_parcel.test.id
