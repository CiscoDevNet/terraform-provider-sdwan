...
func TestAccDataSourceSdwanTransportIPv6ACLProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_ipv6_acl_feature.test", "sequences.0.match_entries.0.next_header", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_ipv6_acl_feature.test", "sequences.0.match_entries.0.packet_length", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_ipv6_acl_feature.test", "sequences.0.match_entries.0.source_ports.0.port", "8000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_ipv6_acl_feature.test", "sequences.0.match_entries.0.tcp_state", "syn"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_transport_ipv6_acl_feature.test", "sequences.0.actions.0.accept_set_next_hop", "2001:0db8:85a3:0000:0000:8a2e:0370:7334"))
