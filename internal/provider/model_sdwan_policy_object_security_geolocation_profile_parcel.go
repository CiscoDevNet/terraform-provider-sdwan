...
type PolicyObjectSecurityGeolocation struct {
	Id               types.String                             `tfsdk:"id"`
	Version          types.Int64                              `tfsdk:"version"`
	Name             types.String                             `tfsdk:"name"`
	Description      types.String                             `tfsdk:"description"`
	FeatureProfileId types.String                             `tfsdk:"feature_profile_id"`
	Entries          []PolicyObjectSecurityGeolocationEntries `tfsdk:"entries"`
}

type PolicyObjectSecurityGeolocationEntries struct {
...
func (data PolicyObjectSecurityGeolocation) getModel() string {
	return "policy_object_security_geolocation"
}

// End of section. //template:end getModel

// Section below is generated&owned by "gen/generator.go". //template:begin getPath
func (data PolicyObjectSecurityGeolocation) getPath() string {
...
func (data PolicyObjectSecurityGeolocation) toBody(ctx context.Context) string {
	body := ""
...
func (data *PolicyObjectSecurityGeolocation) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(path + "entries"); value.Exists() {
		data.Entries = make([]PolicyObjectSecurityGeolocationEntries, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := PolicyObjectSecurityGeolocationEntries{}
...
func (data *PolicyObjectSecurityGeolocation) updateFromBody(ctx context.Context, res gjson.Result) {
	data.Name = types.StringValue(res.Get("payload.name").String())
	if value := res.Get("payload.description"); value.Exists() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
...
func (data *PolicyObjectSecurityGeolocation) isNull(ctx context.Context, res gjson.Result) bool {
