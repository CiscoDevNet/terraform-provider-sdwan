...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &PolicyObjectIPv6PrefixListProfileParcelDataSource{}
)
...
func (d *PolicyObjectIPv6PrefixListProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
