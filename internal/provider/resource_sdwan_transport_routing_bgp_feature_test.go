...
func TestAccSdwanTransportRoutingBGPProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_bgp_feature.test", "ipv6_neighbors.0.address_families.0.restart_max_number_of_prefixes", "2000"))
	checks = append(checks, resource.TestCheckResourceAttr("sdwan_transport_routing_bgp_feature.test", "ipv6_neighbors.0.address_families.0.restart_threshold", "75"))
