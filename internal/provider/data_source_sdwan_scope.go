...
func (d *ScopeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Scope .",
		...
		Attributes: map[string]schema.Attribute{
			...
			"objects": schema.SetNestedAttribute{
				MarkdownDescription: "List of objects belonging to the scope",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"object_ids": schema.SetAttribute{
							MarkdownDescription: "List of object UUIDs",
			...
			"users": schema.SetAttribute{
				MarkdownDescription: "List of users who reference the scope",
				ElementType:         types.StringType,
				Computed:            true,
			},
		},
...
func (d *ScopeDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
