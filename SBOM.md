...
```bash
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-sdwan/main/sbom/latest/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-sdwan/main/sbom/latest/sbom.cyclonedx.json
```

### Specific Versions
Each release has its own directory:
- `sbom/v1.0.0/sbom.spdx.json`
- `sbom/v1.0.0/sbom.cyclonedx.json`

**Download Example:**
```bash
# Replace VERSION with the desired release version
VERSION=v1.0.0
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-sdwan/main/sbom/${VERSION}/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-sdwan/main/sbom/${VERSION}/sbom.cyclonedx.json
```

### Browse All Versions
View the complete SBOM history in the repository:
https://github.com/CiscoDevNet/terraform-provider-sdwan/tree/main/sbom
...
```bash
# SPDX format
jq '.packages[] | select(.name != "terraform-provider-sdwan") | {name, version}' sbom/latest/sbom.spdx.json
...
git diff v1.0.0 v1.1.0 -- sbom/latest/sbom.spdx.json
```
...
If you have questions about SBOM usage or find issues with the generated SBOMs, please [open an issue](https://github.com/CiscoDevNet/terraform-provider-sdwan/issues) with the `sbom` label.
