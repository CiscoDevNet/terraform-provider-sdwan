...
page_title: "sdwan_service_bgp_routing_profile_parcel Resource - terraform-provider-sdwan"
subcategory: "Profile Parcels"
description: |-
  This resource can manage a Service BGP Routing profile parcel.
  Minimum SD-WAN Manager version: 20.12.0
---

# sdwan_service_bgp_routing_profile_parcel (Resource)
