...
- `omp_tag` (Number) OMP tag, Attribute conditional on `type` equal to `ompTag`
  - Range: `0`-`4294967295`
- `preference` (Number) Preference, Attribute conditional on `type` equal to `preference`
  - Range: `0`-`4294967295`
...
- `service_vpn_id` (Number) Service VPN ID, Attribute conditional on `type` equal to `service`
  - Range: `0`-`65536`
- `tloc_action` (String) TLOC action, Attribute conditional on `type` equal to `tlocAction`
...
- `carrier` (String) Carrier, Attribute conditional on `type` equal to `carrier`
  - Choices: `default`, `carrier1`, `carrier2`, `carrier3`, `carrier4`, `carrier5`, `carrier6`, `carrier7`, `carrier8`
- `color_list_id` (String) Color list ID, Attribute conditional on `type` equal to `colorList`
...
- `domain_id` (Number) Domain ID, Attribute conditional on `type` equal to `domainId`
  - Range: `0`-`4294967295`
...
- `group_id` (Number) Group ID, Attribute conditional on `type` equal to `groupId`
  - Range: `0`-`4294967295`
- `omp_tag` (Number) OMP tag, Attribute conditional on `type` equal to `ompTag`
  - Range: `0`-`4294967295`
...
- `path_type` (String) Path type, Attribute conditional on `type` equal to `pathType`
  - Choices: `hierarchical-path`, `direct-path`, `transport-gateway-path`
- `preference` (Number) Preference, Attribute conditional on `type` equal to `preference`
  - Range: `0`-`4294967295`
- `prefix_list_id` (String) Prefix list ID, Attribute conditional on `type` equal to `prefixList`
- `prefix_list_version` (Number) Prefix list version
- `region_id` (Number) Region ID, Attribute conditional on `type` equal to `regionId`
  - Range: `0`-`63`
- `region_list_id` (String) Region list ID, Attribute conditional on `type` equal to `regionList`
- `role` (String) Role, Attribute conditional on `type` equal to `role`
  - Choices: `border-router`, `edge-router`
- `site_id` (Number) Site ID, Attribute conditional on `type` equal to `siteId`
  - Range: `0`-`4294967295`
- `site_list_id` (String) Site list ID, Attribute conditional on `type` equal to `siteList`
...
- `tloc_list_id` (String) TLOC list ID, Attribute conditional on `type` equal to `tlocList`
- `tloc_list_version` (Number) TLOC list version
- `vpn_id` (Number) VPN ID, Attribute conditional on `type` equal to `vpn`
  - Range: `0`-`65536`
- `vpn_list_id` (String) VPN list ID, Attribute conditional on `type` equal to `vpnList`
