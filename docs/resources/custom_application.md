...
- `endpoint_type` (String) Endpoint Type, Attribute conditional on SD-WAN Manager version `20.18.1` or higher
  - Choices: `ip`, `fqdn`, `url`
- `endpoint_value` (String) Endpoint Value, Attribute conditional on SD-WAN Manager version `20.18.1` or higher
