...
page_title: "sdwan_transport_route_policy_profile_parcel Resource - terraform-provider-sdwan"
subcategory: "Profile Parcels"
description: |-
  This resource can manage a Transport Route Policy profile parcel.
  Minimum SD-WAN Manager version: 20.12.0
---

# sdwan_transport_route_policy_profile_parcel (Resource)
...
```shell
terraform import sdwan_transport_route_policy_profile_parcel.example "f6b2c44c-693c-4763-b010-895aa3d236bd"
```
