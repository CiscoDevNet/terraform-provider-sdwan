...
- `high_speed_logging_entries` (Attributes Set) High Speed Logging entries for Unified Security Policy (supports multiple HSL servers) (see [below for nested schema](#nestedatt--high_speed_logging_entries))
